"use strict";(()=>{function c(e){let t=document.getElementById(e);if(!t)throw new Error(`missing element #${e}`);return t}async function S(e){let t=await fetch(e);if(!t.ok){let n=t.statusText;try{n=(await t.json()).detail??n}catch{}throw new Error(n)}return t.json()}function d(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function K(e){if(e==null)return"\u2014";let t=e%1440,n=Math.floor(t/60),a=Math.round(t%60),o=n<12?"am":"pm";return`${n%12===0?12:n%12}:${String(a).padStart(2,"0")}${o}`}function Xe(e){if(e==null)return"\u2014";let t=Math.floor(e/60),n=Math.round(e%60);return t?`${t}h ${String(n).padStart(2,"0")}m`:`${n}m`}function Qe(e){return e>0?`+${e}`:String(e)}function Xt(e,t){return e?`${t>=e?"+":""}${((t-e)/e*100).toFixed(1)}%`:t?"new":"\u2014"}var mo="#4aa3ff",yo="#ffa23a";function ho(e,t,n,a=96){let o=[],s=n/111320,i=n/(111320*Math.cos(e*Math.PI/180));for(let r=0;r<=a;r++){let u=r/a*2*Math.PI;o.push([t+i*Math.cos(u),e+s*Math.sin(u)])}return{type:"Feature",geometry:{type:"Polygon",coordinates:[o]},properties:{}}}function V(e){return{type:"FeatureCollection",features:e}}function Qt(e,t){return e.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n.lon,n.lat]},properties:{...n,side:t}}))}function Zt(e){e.addSource("walk",{type:"geojson",data:V([])}),e.addSource("stops-now",{type:"geojson",data:V([])}),e.addSource("stops-prop",{type:"geojson",data:V([])}),e.addLayer({id:"walk-fill",type:"fill",source:"walk",paint:{"fill-color":"#8fb7ff","fill-opacity":.12}}),e.addLayer({id:"walk-line",type:"line",source:"walk",paint:{"line-color":"#8fb7ff","line-width":1.5,"line-dasharray":[2,2]}}),e.addLayer({id:"stops-prop-c",type:"circle",source:"stops-prop",paint:{"circle-radius":7,"circle-color":yo,"circle-opacity":.85,"circle-stroke-width":1,"circle-stroke-color":"#3a2a10"}}),e.addLayer({id:"stops-now-c",type:"circle",source:"stops-now",paint:{"circle-radius":4,"circle-color":mo,"circle-stroke-width":1,"circle-stroke-color":"#0d2036"}});let t=new maplibregl.Popup({closeButton:!1,offset:10});for(let n of["stops-now-c","stops-prop-c"])e.on("mouseenter",n,()=>{e.getCanvas().style.cursor="pointer"}),e.on("mouseleave",n,()=>{e.getCanvas().style.cursor="",t.remove()}),e.on("mousemove",n,a=>{let o=a.features?.[0];if(!o)return;let s=o.properties;t.setLngLat(a.lngLat).setHTML(`<b>${s.name}</b><br>${s.side==="current"?"today":"proposed"}
    ...
    by up to 30%.${Se("boardings")}</p>`}function _o(e){if(!e)return"";let t=d(e.place),n=e.lost||e.gained?`<p class="people-n"><b>${Math.round(e.lost).toLocaleString()}</b>
    ...
    <dl class="facts">
      ...
      ${we(un(a),un(o))}
      <dt>Hours between</dt>
      ${we(Xe(p),Xe(m),pn(p,m,"more"))}
      <dt>Typical wait</dt>
      ${we(r==null?"\u2014":`${r} min`,u==null?"\u2014":`${u} min`,pn(r,u,"less"))}
    ...
    <div class="place-head">
      ...
      <div class="muted">
        from ${d(le(e))} \xB7 ${e.lat.toFixed(5)}, ${e.lon.toFixed(5)} \xB7
        within ${e.radius} m
      </div>
    </div>
    ...
    </div>`}var ke={gone:{color:"#e8232f",size:6},halved:{color:"#ef5c33",size:4.5},less:{color:"#b06a55",size:3},same:{color:"#6b7280",size:2.5},more:{color:"#478a68",size:3},doubled:{color:"#12a163",size:4.5},new:{color:"#0f79c9",size:6},none:{color:"#3a3f4a",size:2}},it="change",_e="change-dots",$e=null,W=new Set;function lt(){return $e}function ct(e){return W.has(e)}function Ln(e,t,n,a,o,s,i){let r={};for(let u of n)r[u]=0;for(let u of e){if(!$n(u,a,o,s,i))continue;let p=n[U(u,ie(t))];p!==void 0&&r[p]++}return r}function $n(e,t,n,a,o){let s=U(e,0),i=U(e,1);return s>=n&&s<=o&&i>=t&&i<=a}function kn(e,t,n,a,o,s,i){let r={riders:{},measured:{},unmeasured:0};for(let u of n)r.riders[u]=0,r.measured[u]=0;for(let u of e){if(!$n(u,a,o,s,i))continue;let p=n[U(u,ie(t))];if(p===void 0)continue;let m=on(u,t);if(m===null){p!=="none"&&r.unmeasured++;continue}r.riders[p]+=m,r.measured[p]++}return r}function Fo(e){let t=e.buckets.map(n=>n.key);return{type:"FeatureCollection",features:e.points.filter(n=>x.some((a,o)=>t[U(n,ie(o))]!=="none")).map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{published:n[2],...Object.fromEntries(x.flatMap((a,o)=>[[`b${o}`,t[U(n,ie(o))]],[`c${o}`,n[nn(o)]],[`p${o}`,n[an(o)]]]))}}))}}function ce(e,t){let n=Object.entries(ke).flatMap(([a,o])=>[a,o[t]]);return["match",["get",`b${e}`],...n,ke.none[t]]}function _n(e){return["interpolate",["linear"],["zoom"],9,["*",ce(e,"size"),.45],12,ce(e,"size"),16,["*",ce(e,"size"),1.9]]}function xn(e){e.addSource(it,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:_e,type:"circle",source:it,paint:{"circle-color":ce(0,"color"),"circle-radius":_n(0),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.5,12,1,16,1.6]}},"walk-fill")}async function ut(e,t,n){return $e=await S(`/api/change?radius=${t}`),e.getSource(it).setData(Fo($e)),dt(e,n),$e}function dt(e,t){let n=x.indexOf(t);e.setPaintProperty(_e,"circle-color",ce(n,"color")),e.setPaintProperty(_e,"circle-radius",_n(n)),pt(e,t)}function Pn(e,t,n){W.has(t)?W.delete(t):W.add(t),pt(e,n)}function On(e,t){W.clear(),pt(e,t)}function pt(e,t){let n=x.indexOf(t),a=["none",...W];e.setFilter(_e,["!",["in",["get",`b${n}`],["literal",a]]])}function Dn(e,t,n){let a=x.indexOf(t),o=e[`b${a}`],s=n.find(p=>p.key===o)?.label??o,i=e[`c${a}`],r=e[`p${a}`];return`<b>${s}</b><br>${i} \u2192 ${r} buses per ${t==="weekday"?"weekday":t}<br><span style="opacity:.6">click for the full comparison</span>`}var mt="surface",Pe="surface-fill",Rn="#6b7280",yt=[[-2,"#d01c2f"],[-1,"#ef5c33"],[-.138,Rn],[.138,Rn],[1,"#12a163"],[2,"#0b7a48"]],D="#e8232f",R="#0f79c9",Tn=2,xe=null,En=!1;function Oe(){return xe}function ht(){return En}function Cn(e,t){if(e<=0||t<=0)return null;let n=Math.log2(t/e);return Math.max(-Tn,Math.min(Tn,n))}function Mn(e,t){return e<=0&&t<=0?"none":e<=0?"new":t<=0?"gone":"ramp"}function Fn(e,t,n,a,o,s,i,r){let u={gone:0,less:0,same:0,more:0,new:0};for(let p of e){let m=i.lat0+(p[1]+.5)*i.dlat,f=i.lon0+(p[0]+.5)*i.dlon;if(m<a||m>s||f<n||f>o)continue;let k=p[et(t)],T=p[tt(t)],F=Mn(k,T);if(F!=="none")if(F==="ramp"){let y=Cn(k,T);u[y<-.138?"less":y>.138?"more":"same"]+=r}else u[F]+=r}return u}function Ao(e){let{lat0:t,lon0:n,dlat:a,dlon:o}=e.origin;return{type:"FeatureCollection",features:e.cells.map(s=>{let i=t+s[1]*a,r=i+a,u=n+s[0]*o,p=u+o;return{type:"Feature",geometry:{type:"Polygon",coordinates:[[[u,i],[p,i],[p,r],[u,r],[u,i]]]},properties:Object.fromEntries(x.flatMap((m,f)=>{let k=s[et(f)],T=s[tt(f)];return[[`k${f}`,Mn(k,T)],[`v${f}`,Cn(k,T)??0]]}))}})}}function An(e){return["case",["==",["get",`k${e}`],"gone"],D,["==",["get",`k${e}`],"new"],R,["interpolate",["linear"],["get",`v${e}`],...yt.flatMap(([t,n])=>[t,n])]]}function q(e,t){return["case",["in",["get",`k${e}`],["literal",["gone","new"]]],t,["interpolate",["linear"],["abs",["get",`v${e}`]],0,t*.45,1,t]]}function Nn(e,t){e.addSource(mt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Pe,type:"fill",source:mt,layout:{visibility:"none"},paint:{"fill-color":An(0),"fill-antialias":!1,"fill-opacity":["interpolate",["linear"],["zoom"],9,q(0,.85),13,q(0,.62),16,q(0,.45)]}},t)}async function gt(e,t,n){return xe=await S(`/api/surface?radius=${t}`),e.getSource(mt).setData(Ao(xe)),ft(e,n),xe}function ft(e,t){let n=x.indexOf(t);e.setPaintProperty(Pe,"fill-color",An(n)),e.setPaintProperty(Pe,"fill-opacity",["interpolate",["linear"],["zoom"],9,q(n,.85),13,q(n,.62),16,q(n,.45)])}function Hn(e,t){En=t,e.setLayoutProperty(Pe,"visibility",t?"visible":"none")}var bt=null;function De(){return bt}async function vt(e){return bt=await S(`/api/population?radius=${e}`),bt}function Bn(e,t,n,a,o,s,i){let r={lost:0,gained:0,kept:0,none:0};for(let u of e){let p=i.lat0+(u[1]+.5)*i.dlat,m=i.lon0+(u[0]+.5)*i.dlon;p<a||p>s||m<n||m>o||(r.lost+=u[sn(t)],r.gained+=u[rn(t)],r.kept+=u[ln(t)],r.none+=u[cn(t)])}return r}var wt="corridor",jn="corridor-lines",Ee="#8b929c",No="#6f7783",Te={lost:D,added:R,kept:Ee};var Re=null,Un=!1;function Ce(){return Re}function St(){return Un}function Ho(e){return{type:"FeatureCollection",features:e.runs.map(t=>({type:"Feature",geometry:{type:"LineString",coordinates:t.geometry},properties:{klass:t.klass,length_m:t.length_m}}))}}function Jn(e){let t=e.kept+e.lost;return{lostPct:t>0?e.lost/t*100:0,addedPct:t>0?e.added/t*100:0}}function Bo(){let e=t=>["match",["get","klass"],"lost",Te.lost,"added",Te.added,t];return["interpolate",["linear"],["zoom"],9,e(No),14,e(Ee)]}function jo(){let e=["match",["get","klass"],"kept",.85,1];return["interpolate",["linear"],["zoom"],9,["*",e,1.2],13,["*",e,2.6],16,["*",e,6]]}function Uo(){return["match",["get","klass"],"kept",.85,.9]}function In(e,t){e.addSource(wt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:jn,type:"line",source:wt,layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":Bo(),"line-width":jo(),"line-opacity":Uo()}},t)}async function Lt(e,t){return Re=await S(`/api/corridors?day=${t}`),e.getSource(wt).setData(Ho(Re)),Re}async function Gn(e,t){x.includes(t)&&await Lt(e,t)}function zn(e,t){Un=t,e.setLayoutProperty(jn,"visibility",t?"visible":"none")}var kt="#2b3038",Yn="#b9bec6",ue={loses:{color:D,size:6},gains:{color:R,size:6},keeps:{color:Ee,size:3},here:{color:kt,size:3.5},none:{color:Yn,size:1.8}},Fe=["loses","gains","keeps","none","here"],$t="oneseat",Kn="oneseat-dots",Me=null,Vn=!1;function X(){return Me}function _t(){return Vn}function Wn(e,t,n,a,o,s){let i={};for(let r of t)i[r]=0;for(let r of e){let u=r[0],p=r[1];if(u<a||u>s||p<n||p>o)continue;let m=t[r[3]];m!==void 0&&i[m]++}return i}function Jo(e){let t=e.statuses.map(n=>n.key);return{type:"FeatureCollection",features:e.points.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{status:t[n[3]],current:n[4],proposed:n[5]}}))}}function Io(){return["match",["get","status"],...Object.entries(ue).flatMap(([e,t])=>[e,t.color]),Yn]}function Go(){let e=["match",["get","status"],...Object.entries(ue).flatMap(([t,n])=>[t,n.size]),ue.none.size];return["interpolate",["linear"],["zoom"],9,["*",e,.45],12,e,16,["*",e,1.9]]}function qn(e,t){e.addSource($t,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Kn,type:"circle",source:$t,layout:{visibility:"none"},paint:{"circle-color":Io(),"circle-radius":Go(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function zo(e){return"key"in e?`dest=${encodeURIComponent(e.key)}`:`dest_lat=${e.lat.toFixed(6)}&dest_lon=${e.lon.toFixed(6)}`}var Yo="pin";function Xn(e){return"key"in e?e.key:Yo}var Ae="any";function Ko(e,t,n){return`radius=${e}&${zo(t)}&day=${n}`}function Qn(e,t){return e?t:Ae}function Zn(e,t,n){return e==="places"?n==="service":e!=="oneseat"||t}async function xt(e,t,n,a=Ae){return Me=await S(`/api/oneseat?${Ko(t,n,a)}`),e.getSource($t).setData(Jo(Me)),Me}function ea(e,t){Vn=t,e.setLayoutProperty(Kn,"visibility",t?"visible":"none")}function Pt(e){let t=e.destination;return t.name?t.name:t.lat!=null&&t.lon!=null?`${t.lat.toFixed(4)}, ${t.lon.toFixed(4)}`:"the destination"}function ta(e,t){let n=t.statuses.find(r=>r.key===e.status)?.label??e.status,a=(e.current||"").split(";").filter(Boolean),o=(e.proposed||"").split(";").filter(Boolean),s=r=>r.length?r.join(", "):"none",i=Pt(t);return e.status==="here"?`<b>at ${i}</b><br><span style="opacity:.6">no one-seat ride needed</span>`:`<b>${n}</b> \u2014 ${i}<br>today: ${s(a)}<br>proposed: ${s(o)}`}var Ot={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"};function Vo(e){return e.buckets.filter(t=>t.key!=="none")}var na={area:"Ground",people:"People"};function Wo(e,t,n){let a=e.cell_m*e.cell_m/1e6,o=Fn(e.cells,e.days.indexOf(t),n.west,n.south,n.east,n.north,e.origin,a),s=i=>i.toFixed(i<10?1:0);return`
      <div class="lg-area">
    ...
    <div class="lg-foot">A piece of street either has a bus on it or it doesn't \u2014
      ...
      what you can still reach on foot.</div>`}function sa(e,t,n){let a=t.statuses.map(m=>m.key),o=Wn(t.points,a,n.west,n.south,n.east,n.north),s=m=>t.statuses.find(f=>f.key===m)?.label??m,i=Fe.reduce((m,f)=>m+(o[f]??0),0),r=Pt(t),u=t.day&&t.day!==Ae,p=u?`Restricted to routes running on ${Ot[t.day]} at both ends \u2014 <b>not</b> the published day-free answer, which counts a
    ...
    ${Fe.map(m=>`
      <div class="lg-row lg-static">
        <i style="background:${ue[m].color}"></i>
    ...
    that may understate ridership by up to 30%.</div>`}function ia(e,t){let{layer:n,day:a,bounds:o,weight:s,surface:i,unit:r="area",population:u}=t,p=n.buckets.map(v=>v.key),m=n.days.indexOf(a),{west:f,south:k,east:T,north:F}=o,y=Vo(n),se=Ln(n.points,m,p,f,k,T,F),O=s==="riders"?kn(n.points,m,p,f,k,T,F):null,re=v=>O?O.measured[v]?Math.round(O.riders[v]).toLocaleString():"\u2014":se[v].toLocaleString(),po=O?`<b>${Math.round(y.reduce((v,qe)=>v+O.riders[qe.key],0)).toLocaleString()}</b> daily boardings in view`:`<b>${y.reduce((v,qe)=>v+se[qe.key],0).toLocaleString()}</b>
    ...
    <div class="place-head">
      ...
      <div class="muted">
        ...
        ${e.day} \xB7 ready at any minute between ${K(e.window.start_min)}
        and ${K(e.window.end_min)}
      </div>
    ...
    <p class="lg-foot">Rides follow the street the bus drives; dashed sections
      ...
      panel answers at a stricter one too.</p>`}var Mt="places",Pa="places-points",Ft="places-boundaries",E="places-fill",Q="lost",ls=100,cs={lost:"share_lost",gained:"share_gained"};function H(e,t){return`service_${e}_${t}`}var Oa={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},us="Every one of Allegheny County's 1,238,177 residents is in a named place: places are assigned by boundary, not by distance to a labelled stop, so nobody here goes unnamed. Every figure is Allegheny-only and day-free \u2014 losing all buses on any day of the week \u2014 so it does not move with the toolbar's day switch. A place with under 100 residents is shown without a share: a denominator that small cannot carry one.",I={lost:D,gained:R},je=null,J=null,de=null,Da=!1;function At(){return je}function Ra(){return J}function Nt(){return de}function pe(){return Da}function ds(e,t){let n=[...e];return t==="count"?n.sort((a,o)=>o.residents_lost-a.residents_lost):n.sort((a,o)=>(o.share_lost??-1)-(a.share_lost??-1))}function ps(e){return e.residents_gained>e.residents_lost?"gained":"lost"}function ms(e){return Math.max(e.residents_lost,e.residents_gained)}var _a=4,ys=16,hs=1e3;function gs(e){let t=Math.min(1,Math.sqrt(e/hs));return _a+t*(ys-_a)}function fs(e){return{type:"FeatureCollection",features:e.changed.map(t=>({type:"Feature",geometry:{type:"Point",coordinates:[t.lon,t.lat]},properties:{geoid:t.geoid,klass:ps(t),residents_lost:t.residents_lost,residents_gained:t.residents_gained,radius:gs(ms(t))}}))}}function bs(){return["match",["get","klass"],"lost",I.lost,"gained",I.gained,I.lost]}function vs(){return["interpolate",["linear"],["zoom"],9,["*",["get","radius"],.5],12,["get","radius"],16,["*",["get","radius"],1.6]]}var A=[{max:0,label:"No loss, or too few residents to share",opacity:0},{max:.05,label:"Up to 5%",opacity:.15},{max:.15,label:"5\u201315%",opacity:.35},{max:.3,label:"15\u201330%",opacity:.55},{max:null,label:"Over 30%",opacity:.8}];var N=[{max:10,opacity:0},{max:30,opacity:.3},{max:60,opacity:.55},{max:1/0,opacity:.8}];function Ta(e,t){return e==="service"?["step",["abs",["coalesce",["get",H(t,"pct")],0]],N[0].opacity,N[0].max,N[1].opacity,N[1].max,N[2].opacity,N[2].max,N[3].opacity]:["step",["coalesce",["get",cs[e]],0],A[0].opacity,Number.EPSILON,A[1].opacity,A[1].max,A[2].opacity,A[2].max,A[3].opacity,A[3].max,A[4].opacity]}function Ea(e,t){return e==="service"?["case",[">=",["coalesce",["get",H(t,"pct")],0],0],R,D]:I[e]}function ws(e,t){let n=H(t,"now"),a=H(t,"proposed");return e.features.filter(o=>o.properties[n]===0&&o.properties[a]>0).map(o=>o.properties.place)}var Ss=3;function Ls(e){if(e.length===0)return"";let t=e.slice(0,Ss),n=e.length-t.length,a=t.length<=1?t.join(""):`${t.slice(0,-1).join(", ")} and ${t[t.length-1]}`,o=n>0?`${a} (and ${n} more)`:a;return e.length===1?`1 place gets its first bus and cannot be shown as a percentage: ${o}.`:`${e.length} places get their first bus and cannot be shown as a percentage: ${o}.`}function Ca(e,t){e.addSource(Ft,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:E,type:"fill",source:Ft,layout:{visibility:"none"},paint:{"fill-color":Ea(Q),"fill-opacity":Ta(Q),"fill-outline-color":"rgba(255,255,255,.25)"}},t),e.addSource(Mt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Pa,type:"circle",source:Mt,layout:{visibility:"none"},paint:{"circle-color":bs(),"circle-radius":vs(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function Ue(e,t,n){e.setPaintProperty(E,"fill-color",Ea(t,n)),e.setPaintProperty(E,"fill-opacity",Ta(t,n))}async function Ma(){return je||(je=await S("/api/places")),je}async function Fa(e){return de||(de=await S("/api/boundaries"),e.getSource(Ft).setData(de)),de}async function Aa(e,t){try{J=await S(`/api/places/${encodeURIComponent(t)}`)}catch{return J=null,null}return e.getSource(Mt).setData(fs(J)),e.flyTo({center:[J.lon,J.lat],zoom:13}),J}function Na(e,t){Da=t,e.setLayoutProperty(Pa,"visibility",t?"visible":"none"),e.setLayoutProperty(E,"visibility",t?"visible":"none")}function $s(e,t){let n=e.share_lost==null?`<span class="place-share muted" title="Too few residents here to put a share on: this place's measured population is under 100.">\u2014</span>`:`<span class="place-share muted">${(e.share_lost*100).toFixed(1)}% of the place</span>`;return`
    ...
    <div class="place-list">${o}</div>`}function Ba(e){return e?`<div class="lg-head"><b>${d(e.place)}</b>
        <span class="muted">\xB7 ${e.changed_block_groups} block group${e.changed_block_groups===1?"":"s"} changed</span></div>`:'<div class="lg-head">Click a place to see its changed block groups</div>'}function _s(e,t){return e.max===1/0?`Over ${t}%`:`${t}\u2013${e.max}%`}function xs(e,t,n){let a=N.map((r,u)=>({band:r,prevMax:u===0?0:N[u-1].max})).filter(({band:r})=>r.opacity>0).flatMap(({band:r,prevMax:u})=>{let p=_s(r,u);return[`<div class="lg-row lg-static">
          ...
          <i style="background:${R};opacity:${r.opacity};border-radius:2px"></i>
    ...
    ${i.join("<br>")}<br>
    <span class="muted">${a} residents total \xB7 ${e.changed_block_groups} block group${e.changed_block_groups===1?"":"s"} changed</span>`}function xa(e,t,n){let a=Math.round(t).toLocaleString(),o=n==null?`share withheld \u2014 under ${ls} residents`:`${(n*100).toFixed(1)}%`;return`${a} ${e} (${o})`}var Ht=" \xB7 ",Bt={dots:"Locations",surface:"Surface",both:"Locations + surface",corridors:"Streets",oneseat:"One-seat ride",journey:"Travel time",places:"Places"},Ja=Object.keys(Bt);function Ia(e){return Bt[e]??e}var Os={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},Ds=["oneseat","journey"];function Rs(e){return e!=="journey"}function Ts(e){let t=[Bt[e.view]??e.view];return e.view==="places"?t[0]:(Ds.includes(e.view)&&(t[0]+=` to ${e.destination}`),t.push(e.view==="oneseat"&&!e.oneSeatRestricted?"any day":Os[e.day]),Rs(e.view)&&t.push(`${e.radius} m walk`),t.join(Ht))}function Ga(e){let[t,...n]=Ts(e).split(Ht);return`<b>${d(t)}</b>${n.map(a=>Ht+d(a)).join("")}`}var b={view:"view",day:"day",radius:"radius",oneSeatDay:"oneseatday",dest:"dest",weight:"weight",surfaceUnit:"surfaceunit",at:"at",camera:"map",place:"place",placeFill:"placefill"},Je={any:"any",selected:"selected"},Es="pin",za=5;function Ka(e){try{return e.self!==e.top}catch{return!0}}function Va(e){let t=new URLSearchParams;return t.set(b.view,e.view),t.set(b.day,e.day),t.set(b.radius,String(e.radius)),t.set(b.oneSeatDay,e.oneSeatRestricted?Je.selected:Je.any),t.set(b.dest,"key"in e.dest?e.dest.key:jt(e.dest)),e.weight==="riders"&&t.set(b.weight,e.weight),e.surfaceUnit==="people"&&t.set(b.surfaceUnit,e.surfaceUnit),e.at&&t.set(b.at,jt(e.at)),e.camera&&t.set(b.camera,`${jt(e.camera)},${e.camera.zoom.toFixed(2)}`),e.place&&t.set(b.place,e.place),e.placeFill!==Q&&t.set(b.placeFill,e.placeFill),`?${t}`}function Wa(e){let t=new URLSearchParams(e),n={},a=t.get(b.view);a&&Ja.includes(a)&&(n.view=a);let o=t.get(b.day);o&&x.includes(o)&&(n.day=o);let s=Number(t.get(b.radius));t.has(b.radius)&&Number.isFinite(s)&&s>0&&(n.radius=s),t.get(b.weight)==="riders"?n.weight="riders":t.get(b.weight)==="locations"&&(n.weight="locations"),t.get(b.surfaceUnit)==="people"?n.surfaceUnit="people":t.get(b.surfaceUnit)==="area"&&(n.surfaceUnit="area");let i=t.get(b.oneSeatDay);i===Je.selected?n.oneSeatRestricted=!0:i===Je.any&&(n.oneSeatRestricted=!1);let r=t.get(b.dest);if(r&&r!==Es){let k=Ya(r);k?n.dest=k:r.includes(",")||(n.dest={key:r})}let u=Ya(t.get(b.at));u&&(n.at=u);let p=Cs(t.get(b.camera));p&&(n.camera=p);let m=t.get(b.place);m&&(n.place=m);let f=t.get(b.placeFill);return(f==="lost"||f==="gained"||f==="service")&&(n.placeFill=f),n}function jt(e){return`${e.lat.toFixed(za)},${e.lon.toFixed(za)}`}function Ya(e){let t=qa(e,2);return t?{lat:t[0],lon:t[1]}:null}function Cs(e){let t=qa(e,3);return t?{lat:t[0],lon:t[1],zoom:t[2]}:null}function qa(e,t){if(!e)return null;let n=e.split(",").map(Number);return n.length!==t||!n.every(Number.isFinite)?null:n}var Ut="embed";var Ms=["1","true","yes"];function Xa(e){let t=new URLSearchParams(e).get(Ut);return t!==null&&Ms.includes(t.toLowerCase())}function Qa(e){let t=new URLSearchParams(e);return t.set(Ut,"1"),`?${t}`}function Za(e){let t=new URLSearchParams(e);t.delete(Ut);let n=String(t);return n?`?${n}`:""}function eo(e){return(e?`Full answer for ${e}`:"Open the full map")+" \u2197"}var B=["peek","half","full"],Fs=192,As=.3,Ns=.55,Hs=.9,Bs=.6,js=.45;function Ie(e,t){return e==="peek"?Math.min(Fs,t*As):e==="half"?t*Ns:t*Hs}function Us(e,t,n=0){let a=B.map(s=>Math.abs(Ie(s,t)-e)),o=a.indexOf(Math.min(...a));return Math.abs(n)>Bs&&(o=Math.max(0,Math.min(B.length-1,o+(n>0?1:-1)))),B[o]}function to(e){return B[(B.indexOf(e)+1)%B.length]}function Js(e,t){return Math.min(e,t*js)}function Z(){return getComputedStyle(document.documentElement).getPropertyValue("--compact").trim()==="1"}function Jt(e){let t=null,n=()=>{let a=Z();a!==t&&(t=a,e(a))};return window.addEventListener("resize",n),n(),n}var Is=8,Gs=400;function no(e){let t=c("side"),n=c("sheet-handle"),a="peek",o=!1,s=0,i=0,r=0,u={y:0,t:0};function p(){return window.innerHeight}function m(y){t.style.height=`${y}px`,e.onMove(y,Js(y,p()))}function f(y){a=y,t.dataset.snap=y,m(Ie(y,p()))}n.addEventListener("pointerdown",y=>{Z()&&(o=!0,s=y.clientY,i=t.getBoundingClientRect().height,r=y.timeStamp,u={y:y.clientY,t:y.timeStamp},t.classList.add("dragging"),n.setPointerCapture(y.pointerId))}),n.addEventListener("pointermove",y=>{if(!o)return;let se=i+(s-y.clientY),O=Ie("peek",p()),re=Ie("full",p());m(Math.max(O,Math.min(re,se))),u={y:y.clientY,t:y.timeStamp}});function k(y){if(!o)return;if(o=!1,t.classList.remove("dragging"),!(Math.abs(y.clientY-s)>Is)&&y.timeStamp-r<Gs){f(to(a));return}let O=y.timeStamp-u.t,re=O>0?(u.y-y.clientY)/O:0;f(Us(t.getBoundingClientRect().height,p(),re))}n.addEventListener("pointerup",k),n.addEventListener("pointercancel",k),n.addEventListener("keydown",y=>{y.key!=="Enter"&&y.key!==" "||(y.preventDefault(),Z()&&f(to(a)))});let T=Jt(e.onLayoutChange);function F(){if(T(),!Z()){t.style.height="",t.removeAttribute("data-snap"),e.onMove(0,0);return}f(a)}return window.addEventListener("resize",F),F(),{at:()=>Z()?a:"full",atLeast(y){Z()&&B.indexOf(y)>B.indexOf(a)&&f(y)}}}var zs=[-79.9959,40.4406],Ys=12,Ks="#e2574c",P={radius:"data-radius",day:"data-day",oneSeatDay:"data-oneseat-day",view:"data-view",dest:"data-dest",placeFill:"data-place-fill"},ye=Wa(location.search),ge=Xa(location.search);ge&&c("app").classList.add("embed");var Vs={at:()=>"full",atLeast(){}},ao=null,_=400,me=null,g=null,te=null,Y=0,$={key:"downtown"},G=null,oo=!1,ae=!1,Ke="locations",oe="area",so="count",zt=null,C=Q,h="dots",ro,Yt=[],l=new maplibregl.Map({container:"map",style:"https://tiles.openfreemap.org/styles/positron",center:ye.camera?[ye.camera.lon,ye.camera.lat]:zs,zoom:ye.camera?.zoom??Ys,cooperativeGestures:Ka(window),attributionControl:{compact:!0}});l.addControl(new maplibregl.NavigationControl,"top-right");l.on("load",()=>{Zt(l),xn(l),Nn(l,"change-dots"),In(l,"change-dots"),qn(l,"walk-fill"),va(l),Ca(l,"change-dots"),M(),l.on("click",t=>{if(oo){he({lat:t.lngLat.lat,lon:t.lngLat.lng});return}if(h==="places"){let s=l.queryRenderedFeatures(t.point,{layers:[E]})[0];s&&Ge(s.properties.key);return}let n=["change-dots","oneseat-dots"].filter(s=>l.getLayoutProperty(s,"visibility")!=="none"),a=l.queryRenderedFeatures(t.point,{layers:n})[0],o=a?a.geometry.coordinates:[t.lngLat.lng,t.lngLat.lat];qt(o[1],o[0])}),l.on("mouseenter",E,()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave",E,()=>{l.getCanvas().style.cursor=""});let e=new maplibregl.Popup({closeButton:!1,offset:8});l.on("mouseenter","change-dots",()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave","change-dots",()=>{l.getCanvas().style.cursor="",e.remove()}),l.on("mousemove","change-dots",t=>{let n=t.features?.[0],a=lt();!n||!a||e.setLngLat(n.geometry.coordinates).setHTML(Dn(n.properties,L(),a.buckets)).addTo(l)}),l.on("mouseenter","oneseat-dots",()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave","oneseat-dots",()=>{l.getCanvas().style.cursor="",e.remove()}),l.on("mousemove","oneseat-dots",t=>{let n=t.features?.[0],a=X();!n||!a||e.setLngLat(n.geometry.coordinates).setHTML(ta(n.properties,a)).addTo(l)}),l.on("mouseleave",E,()=>e.remove()),l.on("mousemove",E,t=>{let n=t.features?.[0];n&&e.setLngLat(t.lngLat).setHTML(Ua(n.properties,C,L())).addTo(l)}),l.on("moveend",()=>{let t=l.getCenter();ao={lat:t.lat,lon:t.lng,zoom:l.getZoom()},w(),j()}),ee(P.radius,t=>{_=Number(t.dataset.radius),ut(l,_,L()).then(w),Oe()&&gt(l,_,L()).then(w),De()&&vt(_).then(w),X()&&ze(),g&&ne(g.lat,g.lon)}),ee(P.day,t=>{let n=t.dataset.day;hn(n),h!=="journey"&&M(),dt(l,n),ft(l,n),h==="journey"&&g&&Kt(g.lat,g.lon),Ce()&&Gn(l,n).then(w),ae&&X()&&(ze(),g&&ne(g.lat,g.lon)),pe()&&C==="service"&&Ue(l,C,n),w()}),ee(P.oneSeatDay,t=>{ae=t.dataset.oneseatDay==="selected",Gt(),ze(),g&&ne(g.lat,g.lon)}),ee(P.view,t=>{let n=h;h=t.dataset.view,l.setLayoutProperty("change-dots","visibility",h==="dots"||h==="both"?"visible":"none"),er(h==="surface"||h==="both"),nr(h==="corridors"),rr(h==="oneseat"),sr(h==="journey",n==="journey"),ar(h==="places"),h!=="journey"&&n!=="journey"&&(h==="oneseat"||n==="oneseat")&&M({scrollToTop:!0}),or(h!=="corridors"&&h!=="journey"&&h!=="places");let a=h==="oneseat"||h==="journey";c("dest-controls").classList.toggle("hidden",!a),c("oneseat-day-controls").classList.toggle("hidden",h!=="oneseat"),c("place-fill-controls").classList.toggle("hidden",h!=="places"),Gt(),a||Ye(!1),lo()}),ee(P.dest,t=>{let n=t.dataset.dest;if(n==="pin"){Ye(!0);return}Ye(!1),he({key:n})}),ee(P.placeFill,t=>{C=t.dataset.placeFill,pe()&&Ue(l,C,L()),M(),w(),Gt()}),c("legend").addEventListener("click",t=>{let n=t.target.closest("[data-weight]");if(n){Ke=n.dataset.weight,w(),j();return}let a=t.target.closest("[data-surface-unit]");if(a){oe=a.dataset.surfaceUnit,tr(oe),j();return}let o=t.target.closest("[data-bucket]");o&&(Pn(l,o.dataset.bucket,L()),w())}),c("legend-reset").addEventListener("click",()=>{On(l,L()),w()}),c("legend-collapse").addEventListener("click",()=>{It(!c("legend-box").classList.contains("collapsed"))}),c("panel").addEventListener("click",t=>{let n=t.target.closest("[data-goto-dest]");n&&he({key:n.dataset.gotoDest});let a=t.target.closest("[data-caveat]");a&&dr(a.dataset.caveat);let o=t.target.closest("[data-select-place]");o&&Ge(o.dataset.selectPlace);let s=t.target.closest("[data-sort-places]");s&&(so=s.dataset.sortPlaces,M());let i=t.target.closest("[data-goto-place]");i&&(h!=="places"&&z(P.view,"places"),Ge(i.dataset.gotoPlace))}),c("side-toggle").addEventListener("click",Qs),ge&&Jt(It),ro=ge?Vs:no({onMove(t,n){document.documentElement.style.setProperty("--sheet-h",`${t}px`),l.setPadding({top:0,right:0,bottom:n,left:0})},onLayoutChange:It}),qs(),We(),Ve(),Ws(ye)||ut(l,_,L()).then(w),ur(),cr()});function ee(e,t){let n=`[${e}]`;document.querySelectorAll(n).forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(n).forEach(o=>o.classList.toggle("active",o===a)),t(a),We(),j()})})}function z(e,t){let n=document.querySelector(`[${e}="${t}"]`);return n?.click(),n!==null}function Ws(e){let t=!1;return e.radius!==void 0&&(t=z(P.radius,String(e.radius))||t),e.day&&(t=z(P.day,e.day)||t),e.oneSeatRestricted!==void 0&&z(P.oneSeatDay,e.oneSeatRestricted?"selected":"any"),e.weight&&(Ke=e.weight),e.surfaceUnit&&(oe=e.surfaceUnit),e.placeFill&&z(P.placeFill,e.placeFill),e.dest&&("key"in e.dest?z(P.dest,e.dest.key):he(e.dest)),e.view&&z(P.view,e.view),e.at&&qt(e.at.lat,e.at.lon),e.place&&Ge(e.place),t}function j(){let e={view:h,day:L(),radius:_,oneSeatRestricted:ae,weight:Ke,surfaceUnit:oe,dest:$,at:g,camera:ao,place:zt,placeFill:C},t=Va(e);history.replaceState(null,"",(ge?Qa(t):t)+location.hash),Ve(t)}function Ve(e=Za(location.search)){if(!ge)return;let t=c("embed-link");t.href=`${location.pathname}${e}${location.hash}`;let n=g?te?le(te):"this point":null;t.querySelector(".el-action").textContent=eo(n)}function We(){c("statebar").innerHTML=Ga({view:h,day:L(),radius:_,oneSeatRestricted:ae,destination:fe()}),Xs()}function It(e){c("legend-box").classList.toggle("collapsed",e);let t=c("legend-collapse");t.textContent=e?"+":"\u2013",t.title=e?"Show the key":"Collapse the key",t.setAttribute("aria-expanded",String(!e))}function qs(){let e=t=>{c("app").classList.toggle("controls-open",t),c("controls-toggle").setAttribute("aria-expanded",String(t))};c("controls-toggle").addEventListener("click",()=>{e(!c("app").classList.contains("controls-open"))}),c("controls-scrim").addEventListener("click",()=>e(!1)),document.addEventListener("keydown",t=>{t.key==="Escape"&&e(!1)})}function Xs(){c("controls-toggle").firstChild?.remove(),c("controls-toggle").prepend(document.createTextNode(Ia(h)))}function Qs(){let e=c("app").classList.toggle("side-collapsed"),t=c("side-toggle");t.textContent=e?"\u203A":"\u2039",t.title=e?"Show the panel":"Hide the panel",t.setAttribute("aria-expanded",String(!e)),l.resize()}function w(){Zs()}function Zs(){if(c("legend-reset").classList.toggle("hidden",St()||_t()||Tt()||pe()),Tt()){c("legend").innerHTML=ka(Be());return}if(pe()){c("legend").innerHTML=ja(Ra(),C,L(),Nt());return}if(St()){let n=Ce();n&&oa(c("legend"),n);return}if(_t()){let n=X();if(!n)return;let a=l.getBounds();sa(c("legend"),n,{west:a.getWest(),south:a.getSouth(),east:a.getEast(),north:a.getNorth()});return}let e=lt();if(!e)return;let t=l.getBounds();ia(c("legend"),{layer:e,day:L(),bounds:{west:t.getWest(),south:t.getSouth(),east:t.getEast(),north:t.getNorth()},weight:Ke,surface:ht()?Oe():null,unit:oe,population:De()})}async function er(e){if(e&&!Oe()){c("legend").classList.add("loading");try{await gt(l,_,L())}finally{c("legend").classList.remove("loading")}}Hn(l,e),e&&oe==="people"&&await io(),w()}async function io(){if(!De()){c("legend").classList.add("loading");try{await vt(_)}finally{c("legend").classList.remove("loading")}}}async function tr(e){e==="people"&&ht()&&await io(),w()}async function nr(e){if(e&&!Ce()){c("legend").classList.add("loading");try{await Lt(l,L())}finally{c("legend").classList.remove("loading")}}zn(l,e),w()}async function ar(e){if(e&&(!At()||!Nt())){c("legend").classList.add("loading");try{await Promise.all([Ma(),Fa(l)])}finally{c("legend").classList.remove("loading")}}Na(l,e),e&&Ue(l,C,L()),e&&M(),w()}async function Ge(e){zt=e,await Wt(()=>Aa(l,e)),h==="places"&&(M(),document.querySelector(`[data-select-place="${CSS.escape(e)}"]`)?.scrollIntoView({block:"nearest"})),w(),j()}function or(e){document.querySelectorAll("[data-radius]").forEach(t=>{t.disabled=!e})}function M({scrollToTop:e=!1}={}){if(e&&(c("panel").scrollTop=0),Ve(),h==="places"){c("panel").innerHTML=Ha(At()??[],so,zt,C);return}if(!te){h==="oneseat"?c("panel").innerHTML=Sn(fe()):gn(c("panel"));return}if(h==="oneseat"){let t=wn(te,$,L());if(t){c("panel").innerHTML=t;return}}vn(te)}function sr(e,t=!1){if(wa(l,e),w(),!e){t&&(g?ne(g.lat,g.lon):M());return}Be()&&g?c("panel").innerHTML=Ct(Be(),fe()):c("panel").innerHTML=$a(fe())}async function Kt(e,t){let n=++Y;g={lat:e,lon:t},j(),uo(e,t);let a=co(),o=d(fe());if(!a){c("panel").innerHTML=`<div class="empty"><h2>No destination yet</h2>
    ...
    <p class="muted">Routing both networks from this point to
       ${o}, at two transfer distances. A few seconds.</p></div>`;try{let s=await S(Sa({lat:e,lon:t},a,L()));if(n!==Y)return;Et(l,s),c("panel").innerHTML=Ct(s,o),w(),Ve()}catch(s){if(n!==Y)return;Et(l,null),c("panel").innerHTML=`<div class="empty"><h2>No answer for that point</h2>
       <p class="muted">${s.message}</p></div>`}}function Gt(){c("day-controls").classList.toggle("hidden",!Zn(h,ae,C))}function Vt(){return Qn(ae,L())}async function rr(e){e&&!X()&&await Wt(()=>xt(l,_,$,Vt())),ea(l,e),w()}async function ze(){await Wt(()=>xt(l,_,$,Vt())),w()}async function Wt(e){c("legend").classList.add("loading");try{return await e()}finally{c("legend").classList.remove("loading")}}function he(e){if($=e,Ye(!1),ir(),lo(),We(),j(),h==="journey"){g&&Kt(g.lat,g.lon),w();return}g?ne(g.lat,g.lon):M({scrollToTop:!0}),ze()}function lo(){let e=co();if(!(e!==null&&(h==="journey"||h==="oneseat"&&"lat"in $))){G?.remove(),G=null;return}G?G.setLngLat([e.lon,e.lat]).addTo(l):(G=new maplibregl.Marker({color:kt,draggable:!0}).setLngLat([e.lon,e.lat]).addTo(l),G.on("dragend",()=>{let n=G.getLngLat();he({lat:n.lat,lon:n.lng})}))}function ir(){let e=Xn($);document.querySelectorAll("[data-dest]").forEach(t=>{t.classList.toggle("active",t.dataset.dest===e)})}function co(){if("lat"in $)return{lat:$.lat,lon:$.lon};let e=$.key,t=Yt.find(n=>n.key===e);return t?{lat:t.lat,lon:t.lon}:null}function fe(){if("lat"in $)return`${$.lat.toFixed(4)}, ${$.lon.toFixed(4)}`;let e=$.key;return Yt.find(t=>t.key===e)?.name??e}function Ye(e){oo=e,l.getCanvas().style.cursor=e?"crosshair":"",document.querySelectorAll('[data-dest="pin"]').forEach(t=>{t.classList.toggle("armed",e),t.textContent=e?"click the map\u2026":"Pick a point"})}async function ne(e,t){let n=++Y;g={lat:e,lon:t},j(),c("panel").classList.add("loading"),uo(e,t);try{let a="lat"in $?`&dest_lat=${$.lat.toFixed(6)}&dest_lon=${$.lon.toFixed(6)}`:"",o=await S(`/api/place?lat=${e.toFixed(6)}&lon=${t.toFixed(6)}&radius=${_}${a}&oneseat_day=${Vt()}`);if(n!==Y)return;en(l,e,t,_,o.current.stops,o.proposed.stops),lr(),te=o,M({scrollToTop:!0})}catch(a){if(n!==Y)return;c("panel").innerHTML=`<div class="empty"><h2>No answer for that point</h2>
       <p class="muted">${a.message}</p></div>`}finally{n===Y&&c("panel").classList.remove("loading")}}function lr(){c("pin-key").innerHTML=ra(_),c("pin-key").classList.remove("hidden")}function uo(e,t){me?me.setLngLat([t,e]):(me=new maplibregl.Marker({color:Ks,draggable:!0}).setLngLat([t,e]).addTo(l),me.on("dragend",()=>{let n=me.getLngLat();qt(n.lat,n.lng)}))}function qt(e,t){if(ro.atLeast("half"),h==="journey"){Kt(e,t);return}h!=="places"&&ne(e,t)}async function cr(){try{Yt=await S("/api/destinations"),We()}catch{}}async function ur(){try{let e=await S("/api/meta"),t=`today: ${e.feeds.current_feed_version||"current GTFS"} \xB7 proposed: ${e.feeds.proposed_feed_version||"proposed-network feed"}`;c("feedline").textContent=t,c("feedline-methods").textContent=t,c("caveats").innerHTML=e.caveats.map(n=>`<li id="caveat-${n.id}">${n.text}</li>`).join("")}catch{}}function dr(e){c("methods").classList.add("open");let t=document.getElementById(`caveat-${e}`);t&&(t.scrollIntoView({block:"center"}),t.classList.remove("asked"),t.offsetWidth,t.classList.add("asked"))}c("methods-open").addEventListener("click",()=>c("methods").classList.add("open"));c("methods-close").addEventListener("click",()=>c("methods").classList.remove("open"));})();
