"use strict";(()=>{function c(e){let t=document.getElementById(e);if(!t)throw new Error(`missing element #${e}`);return t}async function S(e){let t=await fetch(e);if(!t.ok){let n=t.statusText;try{n=(await t.json()).detail??n}catch{}throw new Error(n)}return t.json()}function p(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ne(e){if(e==null)return"\u2014";let t=e%1440,n=Math.floor(t/60),o=Math.round(t%60),a=n<12?"am":"pm";return`${n%12===0?12:n%12}:${String(o).padStart(2,"0")}${a}`}function $t(e){if(e==null)return"\u2014";let t=Math.floor(e/60),n=Math.round(e%60);return t?`${t}h ${String(n).padStart(2,"0")}m`:`${n}m`}function kt(e){return e>0?`+${e}`:String(e)}function On(e,t){return e?`${t>=e?"+":""}${((t-e)/e*100).toFixed(1)}%`:t?"new":"\u2014"}var gs="#15181e",Dn="#ffa23a",ys="#ffffff";function hs(e,t,n,o=96){let a=[],s=n/111320,r=n/(111320*Math.cos(e*Math.PI/180));for(let i=0;i<=o;i++){let u=i/o*2*Math.PI;a.push([t+r*Math.cos(u),e+s*Math.sin(u)])}return{type:"Feature",geometry:{type:"Polygon",coordinates:[a]},properties:{}}}function G(e){return{type:"FeatureCollection",features:e}}function fs(e){return e.filter(t=>t.moved_m!=null).map(t=>({type:"Feature",geometry:{type:"LineString",coordinates:[[t.moved_lon,t.moved_lat],[t.lon,t.lat]]},properties:{stop_id:t.stop_id,moved_m:t.moved_m}}))}function bs(e){let t=e.side==="current"?"today":"proposed",n=e.moved_m!=null?`<br>moved ${e.moved_m} m from where it stands today`:"";return`<b>${e.name}</b><br>${t} \xB7 stop ${e.stop_id}${n}`}function En(e,t){return e.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n.lon,n.lat]},properties:{...n,side:t}}))}function Tn(e){e.addSource("walk",{type:"geojson",data:G([])}),e.addSource("stops-now",{type:"geojson",data:G([])}),e.addSource("stops-prop",{type:"geojson",data:G([])}),e.addSource("stop-moves",{type:"geojson",data:G([])}),e.addLayer({id:"walk-fill",type:"fill",source:"walk",paint:{"fill-color":"#8fb7ff","fill-opacity":.12}}),e.addLayer({id:"walk-line",type:"line",source:"walk",paint:{"line-color":"#8fb7ff","line-width":1.5,"line-dasharray":[2,2]}}),e.addLayer({id:"stop-moves-l",type:"line",source:"stop-moves",paint:{"line-color":Dn,"line-width":1.5,"line-dasharray":[2,2]}}),e.addLayer({id:"stops-prop-c",type:"circle",source:"stops-prop",paint:{"circle-radius":7,"circle-color":ys,"circle-stroke-width":3,"circle-stroke-color":Dn}}),e.addLayer({id:"stops-now-c",type:"circle",source:"stops-now",paint:{"circle-radius":4,"circle-color":gs,"circle-stroke-width":1,"circle-stroke-color":"rgba(255,255,255,.9)"}});let t=new maplibregl.Popup({closeButton:!1,offset:10});for(let n of["stops-now-c","stops-prop-c"])e.on("mouseenter",n,()=>{e.getCanvas().style.cursor="pointer"}),e.on("mouseleave",n,()=>{e.getCanvas().style.cursor="",t.remove()}),e.on("mousemove",n,o=>{let a=o.features?.[0];if(!a)return;let s=a.properties;t.setLngLat(o.lngLat).setHTML(bs(s)).addTo(e)})}function Cn(e,t,n,o,a,s){e.getSource("walk").setData(G([hs(t,n,o)])),e.getSource("stops-now").setData(G(En(a,"current"))),e.getSource("stops-prop").setData(G(En(s,"proposed"))),e.getSource("stop-moves").setData(G(fs(s)))}var R=["weekday","saturday","sunday"],_t=["early_4_6a","am_6_9a","mid_9a_3p","pm_3_6p","eve_6_8p","late_8_11p","owl_11p_4a"],Mn={early_4_6a:"4\u20136am",am_6_9a:"6\u20139am",mid_9a_3p:"9am\u20133pm",pm_3_6p:"3\u20136pm",eve_6_8p:"6\u20138pm",late_8_11p:"8\u201311pm",owl_11p_4a:"11pm\u20134am"},Te=4,Ce=5,An=e=>Ce+Te*e,Fn=e=>Ce+1+Te*e,he=e=>Ce+2+Te*e,vs=e=>Ce+3+Te*e,Me=2,ws=3,fe=4,be=e=>e[ws],O=(e,t)=>e[t],Nn=(e,t)=>e[vs(t)],xt=e=>2+2*e,Pt=e=>3+2*e,Ae=4,Hn=e=>2+Ae*e,Bn=e=>3+Ae*e,In=e=>4+Ae*e,jn=e=>5+Ae*e;var Ot="weekday";function L(){return Ot}function Vn(e){Ot=e}function Kn(e){e.innerHTML=`
    ...
    <div class="oneseat">
      ...
      ${e.map(o=>{let a=o.status==="here"?'<div class="muted">no one-seat ride needed</div>':He(o.current,o.proposed);return`
      <div class="os-row">
        <div class="os-head">
    ...
    by up to 30%.${Ne("boardings")}</p>`}function Es(e){if(!e)return"";let t=p(e.place),n=e.lost||e.gained?`<p class="people-n"><b>${Math.round(e.lost).toLocaleString()}</b>
    ...
    <dl class="facts">
      ...
      ${Fe(Un(o),Un(a))}
      <dt>Hours between</dt>
      ${Fe($t(d),$t(m),Gn(d,m,"more"))}
      <dt>Typical wait</dt>
      ${Fe(i==null?"\u2014":`${i} min`,u==null?"\u2014":`${u} min`,Gn(i,u,"less"))}
    ...
    </div>`}var Ie={gone:{color:"#e8232f",size:6},halved:{color:"#ef5c33",size:4.5},less:{color:"#b06a55",size:3},same:{color:"#6b7280",size:2.5},more:{color:"#996cb4",size:3},doubled:{color:"#bd60e7",size:4.5},new:{color:"#0f79c9",size:6},none:{color:"#3a3f4a",size:2}},oe="change",z="change-dots",q=["boolean",["feature-state","selected"],!1],eo="#15181e",X=["==",["get","published"],0],Ue="newplace",js="#15181e",Us=5,je=["==",["get","removed"],1],Je="removedstop",Se="change-removed",At="change-removed-selected",Ct="removed-cross",no="#e8232f";function Js(e=2){let t=16*e,n=document.createElement("canvas");n.width=t,n.height=t;let o=n.getContext("2d"),a=t*.2;o.lineCap="round";for(let[s,r]of[[t*.26,"rgba(255,255,255,.95)"],[t*.14,no]])o.lineWidth=s,o.strokeStyle=r,o.beginPath(),o.moveTo(a,a),o.lineTo(t-a,t-a),o.moveTo(t-a,a),o.lineTo(a,t-a),o.stroke();return o.getImageData(0,0,t,t)}var Be=null,Y=new Set,M=new Set,Gs=[z,At,Se],Ft=[z,Se],Ge=z;function oo(e,t){for(let n of Gs)e.getLayer(n)&&e.setLayoutProperty(n,"visibility",t?"visible":"none")}function Nt(){return Be}function Le(e){return Y.has(e)}function ao(e,t,n,o){return a=>Vs(a,e,t,n,o)}function so(e){return t=>e.has(be(t))}function ro(){return M}function io(){return[...M].sort()}function lo(){return M.size}function Ht(e,t){let n=0;for(let o of t)M.has(o)||(M.add(o),we(e,o,!0),n++);return n}function co(e,t){M.delete(t)?we(e,t,!1):(M.add(t),we(e,t,!0))}function uo(e,t){Bt(e),Ht(e,t)}function Bt(e){for(let t of M)we(e,t,!1);M.clear()}function we(e,t,n){try{e.setFeatureState({source:oe,id:t},{selected:n})}catch{}}function Ys(e){for(let t of M)we(e,t,!0)}function zs(e,t,n,o){let a=n*n;return o.filter(s=>(s.x-e)**2+(s.y-t)**2<=a).map(s=>s.id)}function It(e,t,n,o){let a=[[t-o,n-o],[t+o,n+o]],s=[z,Se].filter(i=>e.getLayer(i)),r=e.queryRenderedFeatures(a,{layers:s}).filter(i=>i.id!==void 0).map(i=>{let[u,d]=i.geometry.coordinates,m=e.project([u,d]);return{id:i.id,x:m.x,y:m.y}});return zs(t,n,o,r)}function po(e,t,n,o){let a={};for(let s of n)a[s]=0;for(let s of e){if(!o(s)||O(s,Me)===0||O(s,fe)===1)continue;let r=n[O(s,he(t))];r!==void 0&&a[r]++}return a}function mo(e,t){let n=0;for(let o of e)t(o)&&O(o,Me)===0&&n++;return n}function go(e,t){let n=0;for(let o of e)t(o)&&O(o,fe)===1&&n++;return n}function Vs(e,t,n,o,a){let s=O(e,0),r=O(e,1);return s>=n&&s<=a&&r>=t&&r<=o}function yo(e,t,n,o){let a={riders:{},measured:{},unmeasured:0,removedRiders:0,removedMeasured:0};for(let s of n)a.riders[s]=0,a.measured[s]=0;for(let s of e){if(!o(s)||O(s,Me)===0)continue;let r=n[O(s,he(t))];if(r===void 0)continue;let i=Nn(s,t),u=O(s,fe)===1;if(i===null){r!=="none"&&a.unmeasured++;continue}if(u){a.removedRiders+=i,a.removedMeasured++;continue}a.riders[r]+=i,a.measured[r]++}return a}function Ks(e){let t=e.buckets.map(n=>n.key);return{type:"FeatureCollection",features:e.points.filter(n=>R.some((o,a)=>t[O(n,he(a))]!=="none")).map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{id:be(n),published:n[2],removed:n[fe],replacement:e.replacement?.[be(n)]?.[0]??null,nearestStraight:e.replacement?.[be(n)]?.[1]??null,...Object.fromEntries(R.flatMap((o,a)=>[[`b${a}`,t[O(n,he(a))]],[`c${a}`,n[An(a)]],[`p${a}`,n[Fn(a)]]]))}}))}}function ho(e,t){let n=Object.entries(Ie).flatMap(([o,a])=>[o,a[t]]);return["match",["get",`b${e}`],...n,Ie.none[t]]}function fo(e){return["case",X,"rgba(0,0,0,0)",ho(e,"color")]}function Mt(e){return["case",X,Us,ho(e,"size")]}function bo(e){return["interpolate",["linear"],["zoom"],9,["*",Mt(e),.45],12,Mt(e),16,["*",Mt(e),1.9]]}function vo(e){e.addSource(oe,{type:"geojson",promoteId:"id",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:z,type:"circle",source:oe,paint:{"circle-color":fo(0),"circle-radius":bo(0),"circle-opacity":.85,"circle-stroke-color":["case",q,eo,X,js,"rgba(255,255,255,.9)"],"circle-stroke-width":["interpolate",["linear"],["zoom"],9,["case",q,1.6,X,.9,.5],12,["case",q,2.4,X,1.5,1],16,["case",q,3.2,X,2.2,1.6]]}},"walk-fill"),e.addLayer({id:At,type:"circle",source:oe,filter:je,paint:{"circle-color":"rgba(0,0,0,0)","circle-stroke-color":eo,"circle-radius":["interpolate",["linear"],["zoom"],9,3.5,12,6,16,10],"circle-stroke-width":["interpolate",["linear"],["zoom"],9,["case",q,1.6,0],12,["case",q,2.4,0],16,["case",q,3.2,0]]}},"walk-fill"),e.hasImage(Ct)||e.addImage(Ct,Js(),{pixelRatio:2}),e.addLayer({id:Se,type:"symbol",source:oe,filter:je,layout:{"icon-image":Ct,"icon-size":["interpolate",["linear"],["zoom"],9,.34,12,.55,16,1],"icon-allow-overlap":!0,"icon-ignore-placement":!0}},"walk-fill")}async function jt(e,t,n){return Be=await S(`/api/change?radius=${t}`),e.getSource(oe).setData(Ks(Be)),Ys(e),Ut(e,n),Be}function Ut(e,t){let n=R.indexOf(t);e.setPaintProperty(z,"circle-color",fo(n)),e.setPaintProperty(z,"circle-radius",bo(n)),Jt(e,t)}function wo(e,t,n){Y.has(t)?Y.delete(t):Y.add(t),Jt(e,n)}function So(e,t){Y.clear(),Jt(e,t)}function Jt(e,t){let n=R.indexOf(t),o=["none",...Y],a=["case",X,!Y.has(Ue),["!",["in",["get",`b${n}`],["literal",o]]]];e.setFilter(z,["all",["!",je],a]);let s=["all",je,!Y.has(Je)];e.setFilter(Se,s),e.setFilter(At,s)}function Lo(e,t,n){let o=R.indexOf(t),a=e[`b${o}`],s=e.removed===1,r=e.published===0?"the plan adds a stop here":n.find(b=>b.key===a)?.label??a,i=e[`c${o}`],u=e[`p${o}`],d=t==="weekday"?"weekday":t,m=e.published===0||s?" within a walk":"";return`${s?"":`<b>${r}</b><br>`}${qs(e)}${i} \u2192 ${u} buses per ${d}${m}<br><span style="opacity:.6">click for the full comparison</span>`}var Ws=1.5,to=800;function qs(e){if(e.removed!==1)return"";let t=e.replacement,n=e.nearestStraight,o=t??to,a=n!=null&&o>n*Ws?`; the nearest in a straight line is ${Math.round(n).toLocaleString()} m`:"",s=t==null?`no other stop within a ${to} m walk${a}`:`nearest stop is a ${Math.round(t).toLocaleString()} m walk${a}`;return`<b style="color:${no}">Stop removed</b> \u2014 ${s}<br>`}var Gt="surface",ze="surface-fill",$o="#6b7280",Yt=[[-2,"#d01c2f"],[-1,"#ef5c33"],[-.138,$o],[.138,$o],[1,"#bd60e7"],[2,"#961bed"]],T="#e8232f",C="#0f79c9",ko=2,Ye=null,_o=!1;function Ve(){return Ye}function zt(){return _o}function xo(e,t){if(e<=0||t<=0)return null;let n=Math.log2(t/e);return Math.max(-ko,Math.min(ko,n))}function Po(e,t){return e<=0&&t<=0?"none":e<=0?"new":t<=0?"gone":"ramp"}function Ro(e,t,n,o,a,s,r,i){let u={gone:0,less:0,same:0,more:0,new:0};for(let d of e){let m=r.lat0+(d[1]+.5)*r.dlat,b=r.lon0+(d[0]+.5)*r.dlon;if(m<o||m>s||b<n||b>a)continue;let k=d[xt(t)],_=d[Pt(t)],U=Po(k,_);if(U!=="none")if(U==="ramp"){let y=xo(k,_);u[y<-.138?"less":y>.138?"more":"same"]+=i}else u[U]+=i}return u}function Xs(e){let{lat0:t,lon0:n,dlat:o,dlon:a}=e.origin;return{type:"FeatureCollection",features:e.cells.map(s=>{let r=t+s[1]*o,i=r+o,u=n+s[0]*a,d=u+a;return{type:"Feature",geometry:{type:"Polygon",coordinates:[[[u,r],[d,r],[d,i],[u,i],[u,r]]]},properties:Object.fromEntries(R.flatMap((m,b)=>{let k=s[xt(b)],_=s[Pt(b)];return[[`k${b}`,Po(k,_)],[`v${b}`,xo(k,_)??0]]}))}})}}function Oo(e){return["case",["==",["get",`k${e}`],"gone"],T,["==",["get",`k${e}`],"new"],C,["interpolate",["linear"],["get",`v${e}`],...Yt.flatMap(([t,n])=>[t,n])]]}function ae(e,t){return["case",["in",["get",`k${e}`],["literal",["gone","new"]]],t,["interpolate",["linear"],["abs",["get",`v${e}`]],0,t*.45,1,t]]}function Do(e,t){e.addSource(Gt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:ze,type:"fill",source:Gt,layout:{visibility:"none"},paint:{"fill-color":Oo(0),"fill-antialias":!1,"fill-opacity":["interpolate",["linear"],["zoom"],9,ae(0,.85),13,ae(0,.62),16,ae(0,.45)]}},t)}async function Vt(e,t,n){return Ye=await S(`/api/surface?radius=${t}`),e.getSource(Gt).setData(Xs(Ye)),Kt(e,n),Ye}function Kt(e,t){let n=R.indexOf(t);e.setPaintProperty(ze,"fill-color",Oo(n)),e.setPaintProperty(ze,"fill-opacity",["interpolate",["linear"],["zoom"],9,ae(n,.85),13,ae(n,.62),16,ae(n,.45)])}function Eo(e,t){_o=t,e.setLayoutProperty(ze,"visibility",t?"visible":"none")}var Wt=null;function Ke(){return Wt}async function qt(e){return Wt=await S(`/api/population?radius=${e}`),Wt}function To(e,t,n,o,a,s,r){let i={lost:0,gained:0,kept:0,none:0};for(let u of e){let d=r.lat0+(u[1]+.5)*r.dlat,m=r.lon0+(u[0]+.5)*r.dlon;d<o||d>s||m<n||m>a||(i.lost+=u[Hn(t)],i.gained+=u[Bn(t)],i.kept+=u[In(t)],i.none+=u[jn(t)])}return i}var Xt="corridor",Co="corridor-lines",Xe="#8b929c",Qs="#6f7783",qe={lost:T,added:C,kept:Xe};var We=null,Mo=!1;function Qe(){return We}function Qt(){return Mo}function Zs(e){return{type:"FeatureCollection",features:e.runs.map(t=>({type:"Feature",geometry:{type:"LineString",coordinates:t.geometry},properties:{klass:t.klass,length_m:t.length_m}}))}}function Ao(e){let t=e.kept+e.lost;return{lostPct:t>0?e.lost/t*100:0,addedPct:t>0?e.added/t*100:0}}function er(){let e=t=>["match",["get","klass"],"lost",qe.lost,"added",qe.added,t];return["interpolate",["linear"],["zoom"],9,e(Qs),14,e(Xe)]}function tr(){let e=["match",["get","klass"],"kept",.85,1];return["interpolate",["linear"],["zoom"],9,["*",e,1.2],13,["*",e,2.6],16,["*",e,6]]}function nr(){return["match",["get","klass"],"kept",.85,.9]}function Fo(e,t){e.addSource(Xt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Co,type:"line",source:Xt,layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":er(),"line-width":tr(),"line-opacity":nr()}},t)}async function Zt(e,t){return We=await S(`/api/corridors?day=${t}`),e.getSource(Xt).setData(Zs(We)),We}async function No(e,t){R.includes(t)&&await Zt(e,t)}function Ho(e,t){Mo=t,e.setLayoutProperty(Co,"visibility",t?"visible":"none")}var tn="#2b3038",Bo="#b9bec6",$e={loses:{color:T,size:6},gains:{color:C,size:6},keeps:{color:Xe,size:3},here:{color:tn,size:3.5},none:{color:Bo,size:1.8}},et=["loses","gains","keeps","none","here"],en="oneseat",Io="oneseat-dots",Ze=null,jo=!1;function se(){return Ze}function nn(){return jo}function Uo(e,t,n,o,a,s){let r={};for(let i of t)r[i]=0;for(let i of e){let u=i[0],d=i[1];if(u<o||u>s||d<n||d>a)continue;let m=t[i[3]];m!==void 0&&r[m]++}return r}function or(e){let t=e.statuses.map(n=>n.key);return{type:"FeatureCollection",features:e.points.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{status:t[n[3]],current:n[4],proposed:n[5]}}))}}function ar(){return["match",["get","status"],...Object.entries($e).flatMap(([e,t])=>[e,t.color]),Bo]}function sr(){let e=["match",["get","status"],...Object.entries($e).flatMap(([t,n])=>[t,n.size]),$e.none.size];return["interpolate",["linear"],["zoom"],9,["*",e,.45],12,e,16,["*",e,1.9]]}function Jo(e,t){e.addSource(en,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Io,type:"circle",source:en,layout:{visibility:"none"},paint:{"circle-color":ar(),"circle-radius":sr(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function rr(e){return"key"in e?`dest=${encodeURIComponent(e.key)}`:`dest_lat=${e.lat.toFixed(6)}&dest_lon=${e.lon.toFixed(6)}`}var ir="pin";function Go(e){return"key"in e?e.key:ir}var tt="any";function lr(e,t,n){return`radius=${e}&${rr(t)}&day=${n}`}function Yo(e,t){return e?t:tt}function zo(e,t,n){return e==="places"?n==="service":e!=="oneseat"||t}async function on(e,t,n,o=tt){return Ze=await S(`/api/oneseat?${lr(t,n,o)}`),e.getSource(en).setData(or(Ze)),Ze}function Vo(e,t){jo=t,e.setLayoutProperty(Io,"visibility",t?"visible":"none")}function an(e){let t=e.destination;return t.name?t.name:t.lat!=null&&t.lon!=null?`${t.lat.toFixed(4)}, ${t.lon.toFixed(4)}`:"the destination"}function Ko(e,t){let n=t.statuses.find(i=>i.key===e.status)?.label??e.status,o=(e.current||"").split(";").filter(Boolean),a=(e.proposed||"").split(";").filter(Boolean),s=i=>i.length?i.join(", "):"none",r=an(t);return e.status==="here"?`<b>at ${r}</b><br><span style="opacity:.6">no one-seat ride needed</span>`:`<b>${n}</b> \u2014 ${r}<br>today: ${s(o)}<br>proposed: ${s(a)}`}var nt={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},sn={weekday:"weekdays",saturday:"Saturdays",sunday:"Sundays"},cr=new Set(["gone","new"]);function ur(e,t,n){return cr.has(e)?`${t} (${sn[n]})`:t}function dr(e){return e.buckets.filter(t=>t.key!=="none")}var Wo={area:"Ground",people:"People"};function pr(e,t,n){let o=e.cell_m*e.cell_m/1e6,a=Ro(e.cells,e.days.indexOf(t),n.west,n.south,n.east,n.north,e.origin,o),s=r=>r.toFixed(r<10?1:0);return`
      <div class="lg-area">
    ...
    <div class="lg-foot">A street either has a bus on it or it doesn't, so
      ...
      Stop-by-stop or Surface.</div>`}function Zo(e,t,n){let o=t.statuses.map(m=>m.key),a=Uo(t.points,o,n.west,n.south,n.east,n.north),s=m=>t.statuses.find(b=>b.key===m)?.label??m,r=et.reduce((m,b)=>m+(a[b]??0),0),i=an(t),u=t.day&&t.day!==tt,d=u?`Restricted to routes running on ${nt[t.day]} at both ends \u2014 <b>not</b> the published answer, which counts a route
    ...
    <div class="lg-head">
      ...
      \xB7 ${t.radius} m walk${u?` \xB7 ${nt[t.day]}`:" \xB7 any day"}</span>
    </div>
    ${et.map(m=>`
      <div class="lg-row lg-static">
    ...
    <div class="lg-ends" style="margin-top:4px">
      citywide: ${et.map(m=>`${(t.counts[m]??0).toLocaleString()} ${p(s(m))}`).join(" \xB7 ")}
    </div>
    ...
    not people, and by PRT's own disclaimer up to 30% low.</div>`}function vr(e){if(!e)return"";let t=Le(Ue);return`
    <button class="lg-row ${t?"off":""}" data-bucket="${Ue}"
            aria-pressed="${!t}">
      <i class="lg-hollow"></i>
      <span class="lg-lab">the plan adds a stop here</span>
      <span class="lg-n">${e.toLocaleString()}</span>
    </button>`}function wr(e,t){if(!e)return"";let n=Le(Je);return`
    <button class="lg-row ${n?"off":""}" data-bucket="${Je}"
            aria-pressed="${!n}">
      <i class="lg-cross"></i>
    ...
    <div class="lg-marks">
      ...
      ${vr(e)}
      ${wr(t,n)}
    </div>`}function ta(e,t){let{layer:n,day:o,bounds:a,weight:s,surface:r,unit:i="area",population:u,selection:d,dots:m=!0}=t,b=n.buckets.map(w=>w.key),k=n.days.indexOf(o),{west:_,south:U,east:y,north:De}=a,J=dr(n),x=d&&d.size>0?d:null,Ee=x?so(x):ao(_,U,y,De),Pn=po(n.points,k,b,Ee),wt=mo(n.points,Ee),St=go(n.points,Ee),E=s==="riders"?yo(n.points,k,b,Ee):null,cs=w=>E?E.measured[w]?Math.round(E.riders[w]).toLocaleString():"\u2014":Pn[w].toLocaleString(),us=E?E.removedMeasured?Math.round(E.removedRiders).toLocaleString():"\u2014":St.toLocaleString(),ds=x?`at ${x.size.toLocaleString()} selected stop${x.size===1?"":"s"}`:"in view",Rn=J.reduce((w,Lt)=>w+Pn[Lt.key],0)+wt+St,ps=E?`<b>${Math.round(J.reduce((w,Lt)=>w+E.riders[Lt.key],0)+E.removedRiders).toLocaleString()}</b> daily boardings ${ds}`:x?`<b>${Rn.toLocaleString()}</b>
         of ${x.size.toLocaleString()} selected stops`:`<b>${Rn.toLocaleString()}</b>
         locations in view`,ms=!m&&!!r;e.innerHTML=ms?`
    <div class="lg-head">
      <b>Surface</b>
      <span class="muted">\xB7 ${nt[o]} \xB7 ${n.radius} m walk</span>
    </div>
    ...
    ${J.map(w=>`
      <button class="lg-row ${Le(w.key)?"off":""}" data-bucket="${p(w.key)}"
        ...
        <i style="background:${Ie[w.key]?.color??"#666"}"></i>
    ...
    <div class="routes">
      ...
      <div class="jl"><span class="jl-what">${at(t.current)} \u2192
        ${at(t.proposed)} min</span>
    ...
    <div class="headline">
      <div class="hl-side">
        <div class="hl-label">today</div>
        <div class="hl-n">${at(n.current)}</div>
      </div>
      <div class="hl-arrow">\u2192</div>
      <div class="hl-side">
        <div class="hl-label">proposed</div>
        <div class="hl-n">${at(n.proposed)}</div>
      </div>
      <div class="hl-delta ${o}">${ha(n.change_min)}</div>
    </div>
    ...
    <p class="lg-foot">Rides follow the street the bus drives; dashed sections
      ...
      panel answers at a stricter one too.</p>`}var lt="places",Sa="places-points",pn="places-boundaries",A="places-fill",ie="lost",Rr=100,Or={lost:"share_lost",gained:"share_gained"};function K(e,t){return`service_${e}_${t}`}var La={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},Dr="Every one of Allegheny County's 1,238,177 residents is in a named place: places are assigned by boundary, not by distance to a labelled stop, so nobody here goes unnamed. Every figure is Allegheny-only and day-free \u2014 losing all buses on any day of the week \u2014 so it does not move with the toolbar's day switch. A place with under 100 residents is shown without a share: a denominator that small cannot carry one.",Q={lost:T,gained:C},rt=null,V=null,re=null,$a=!1,it=null;function mn(){return rt}function ka(){return V}function _a(){return it}function gn(){return re}function ke(){return $a}function Er(e,t){let n=[...e];return t==="count"?n.sort((o,a)=>a.residents_lost-o.residents_lost):n.sort((o,a)=>(a.share_lost??-1)-(o.share_lost??-1))}function Tr(e){return e.residents_gained>e.residents_lost?"gained":"lost"}function Cr(e){return Math.max(e.residents_lost,e.residents_gained)}var va=4,Mr=16,Ar=1e3;function Fr(e){let t=Math.min(1,Math.sqrt(e/Ar));return va+t*(Mr-va)}function Nr(e){return{type:"FeatureCollection",features:e.changed.map(t=>({type:"Feature",geometry:{type:"Point",coordinates:[t.lon,t.lat]},properties:{geoid:t.geoid,klass:Tr(t),residents_lost:t.residents_lost,residents_gained:t.residents_gained,radius:Fr(Cr(t))}}))}}function Hr(){return["match",["get","klass"],"lost",Q.lost,"gained",Q.gained,Q.lost]}function Br(){return["interpolate",["linear"],["zoom"],9,["*",["get","radius"],.5],12,["get","radius"],16,["*",["get","radius"],1.6]]}var I=[{max:0,label:"No loss, or too few residents to share",opacity:0},{max:.05,label:"Up to 5%",opacity:.15},{max:.15,label:"5\u201315%",opacity:.35},{max:.3,label:"15\u201330%",opacity:.55},{max:null,label:"Over 30%",opacity:.8}];var j=[{max:10,opacity:0},{max:30,opacity:.3},{max:60,opacity:.55},{max:1/0,opacity:.8}];function xa(e,t){return e==="service"?["step",["abs",["coalesce",["get",K(t,"pct")],0]],j[0].opacity,j[0].max,j[1].opacity,j[1].max,j[2].opacity,j[2].max,j[3].opacity]:["step",["coalesce",["get",Or[e]],0],I[0].opacity,Number.EPSILON,I[1].opacity,I[1].max,I[2].opacity,I[2].max,I[3].opacity,I[3].max,I[4].opacity]}function Pa(e,t){return e==="service"?["case",[">=",["coalesce",["get",K(t,"pct")],0],0],C,T]:Q[e]}function Ir(e,t){let n=K(t,"now"),o=K(t,"proposed");return e.features.filter(a=>a.properties[n]===0&&a.properties[o]>0).map(a=>a.properties.place)}var jr=3;function Ur(e){if(e.length===0)return"";let t=e.slice(0,jr),n=e.length-t.length,o=t.length<=1?t.join(""):`${t.slice(0,-1).join(", ")} and ${t[t.length-1]}`,a=n>0?`${o} (and ${n} more)`:o;return e.length===1?`1 place gets its first bus and cannot be shown as a percentage: ${a}.`:`${e.length} places get their first bus and cannot be shown as a percentage: ${a}.`}function Ra(e,t){e.addSource(pn,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:A,type:"fill",source:pn,layout:{visibility:"none"},paint:{"fill-color":Pa(ie),"fill-opacity":xa(ie),"fill-outline-color":"rgba(255,255,255,.25)"}},t),e.addSource(lt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Sa,type:"circle",source:lt,layout:{visibility:"none"},paint:{"circle-color":Hr(),"circle-radius":Br(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function ct(e,t,n){e.setPaintProperty(A,"fill-color",Pa(t,n)),e.setPaintProperty(A,"fill-opacity",xa(t,n))}async function Oa(){return rt||(rt=await S("/api/places")),rt}async function Da(e){return re||(re=await S("/api/boundaries"),e.getSource(pn).setData(re)),re}function Jr(e,t){let n=e?.features.find(o=>o.properties.key===t);return n&&n.properties.changed_block_groups===0?n.properties.place:null}async function Ea(e,t){let n=Jr(re,t);if(n)return V=null,it=n,e.getSource(lt)?.setData({type:"FeatureCollection",features:[]}),null;try{V=await S(`/api/places/${encodeURIComponent(t)}`)}catch{return V=null,it=null,null}return it=null,e.getSource(lt).setData(Nr(V)),e.flyTo({center:[V.lon,V.lat],zoom:13}),V}function Ta(e,t){$a=t,e.setLayoutProperty(Sa,"visibility",t?"visible":"none"),e.setLayoutProperty(A,"visibility",t?"visible":"none")}function Gr(e,t){let n=e.share_lost==null?`<span class="place-share muted" title="Too few residents here to put a share on: this place's measured population is under 100.">\u2014</span>`:`<span class="place-share muted">${(e.share_lost*100).toFixed(1)}% of the place</span>`;return`
    ...
    </button>`}var Yr="Unlike the two residents readings above, this one moves with the toolbar's day switch: it is asking about the plan's actual weekday, Saturday or Sunday service, not residents' day-free losses and gains.";function Ca(e,t,n,o){let a=Er(e,t).map(s=>Gr(s,s.key===n)).join("");return`
    <div class="place-head">
      <h2>Places</h2>
    ...
    <div class="place-list">${a}</div>`}function Ma(e,t){return e?`<div class="lg-head"><b>${p(e.place)}</b>
      ...
      <div class="lg-foot muted">No block group in it loses or gains all
        service. Shaded places are the ones with something to show.</div>`:'<div class="lg-head">Click a place to see its changed block groups</div>'}function zr(e,t){return e.max===1/0?`Over ${t}%`:`${t}\u2013${e.max}%`}function Vr(e,t,n,o){let a=j.map((u,d)=>({band:u,prevMax:d===0?0:j[d-1].max})).filter(({band:u})=>u.opacity>0).flatMap(({band:u,prevMax:d})=>{let m=zr(u,d);return[`<div class="lg-row lg-static">
          ...
          <span class="lg-lab">${p(m)} more trips</span></div>`]}).join(""),s=o?Ir(o,n):[],r=Ur(s),i=r?`<div class="lg-foot">${p(r)}</div>`:"";return`
    ${Ma(e,t)}
    ...
    <div class="lg-foot">Fill is signed: red where a place's own trips fall,
      ...
      it.</div>`}function Aa({selected:e,fill:t,day:n,boundaries:o,unchanged:a}){if(t==="service")return Vr(e,a??null,n,o??null);let s=t==="lost"?"lose all buses":"gain a bus",r=I.filter(i=>i.opacity>0).map(i=>`
    <div class="lg-row lg-static">
    ...
    <div class="lg-foot">Fill is coloured by SHARE, not by count of residents
      ...
      it; size is the larger of a block group's losses or gains.</div>`}function Kr(e,t){let n=e[K(t,"now")],o=e[K(t,"proposed")],a=e[K(t,"pct")],s=e[K(t,"rail_proposed")],r=La[t];if(o===0&&n>0)return`Loses all buses on ${r} (${n} \u2192 0 trips)${s?"; the T still calls here":""}.`;if(n===0&&o>0)return`Gets its first bus on ${r} (0 \u2192 ${o} trips).`;let i=a==null?"\u2014":`${a>0?"+":""}${a.toFixed(1)}%`;return`${n} \u2192 ${o} trips on ${r} (${i}).`}function Fa(e,t,n){if(t==="service")return`<b>${p(e.place)}</b> <span class="muted">\xB7 ${p(e.kind)}</span><br>
      ${Kr(e,n)}`;let o=Math.round(e.residents_total??0).toLocaleString();if(e.changed_block_groups===0)return`<b>${p(e.place)}</b> <span class="muted">\xB7 ${p(e.kind)}</span><br>
    ...
    ${r.join("<br>")}<br>
    <span class="muted">${o} residents total \xB7 ${e.changed_block_groups} block group${e.changed_block_groups===1?"":"s"} changed</span>`}function wa(e,t,n){let o=Math.round(t).toLocaleString(),a=n==null?`share withheld \u2014 under ${Rr} residents`:`${(n*100).toFixed(1)}%`;return`${o} ${e} (${a})`}var yn=" \xB7 ",hn={dots:"Stop-by-stop",surface:"Surface",both:"Stop-by-stop + surface",corridors:"Streets",oneseat:"One-seat ride",journey:"Travel time",places:"Places"},Na=Object.keys(hn);function Ha(e){return hn[e]??e}var Wr={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},qr=["oneseat","journey"];function Xr(e){return e!=="journey"}function Qr(e){let t=[hn[e.view]??e.view];return e.view==="places"?t[0]:(qr.includes(e.view)&&(t[0]+=` to ${e.destination}`),t.push(e.view==="oneseat"&&!e.oneSeatRestricted?"any day":Wr[e.day]),Xr(e.view)&&t.push(`${e.radius} m walk`),t.join(yn))}function Ba(e){let[t,...n]=Qr(e).split(yn);return`<b>${p(t)}</b>${n.map(o=>yn+p(o)).join("")}`}var h={view:"view",day:"day",radius:"radius",oneSeatDay:"oneseatday",dest:"dest",weight:"weight",surfaceUnit:"surfaceunit",at:"at",camera:"map",place:"place",placeFill:"placefill",selection:"sel"},Zr=/^[cp]:[\w.:-]{1,32}$/,ut={any:"any",selected:"selected"},ei="pin",Ia=5;function Ua(e){try{return e.self!==e.top}catch{return!0}}function Ja(e){let t=new URLSearchParams;return t.set(h.view,e.view),t.set(h.day,e.day),t.set(h.radius,String(e.radius)),t.set(h.oneSeatDay,e.oneSeatRestricted?ut.selected:ut.any),t.set(h.dest,"key"in e.dest?e.dest.key:fn(e.dest)),e.weight==="riders"&&t.set(h.weight,e.weight),e.surfaceUnit==="people"&&t.set(h.surfaceUnit,e.surfaceUnit),e.at&&t.set(h.at,fn(e.at)),e.camera&&t.set(h.camera,`${fn(e.camera)},${e.camera.zoom.toFixed(2)}`),e.place&&t.set(h.place,e.place),e.placeFill!==ie&&t.set(h.placeFill,e.placeFill),e.selection.length&&t.set(h.selection,e.selection.join(",")),`?${t}`}function Ga(e){let t=new URLSearchParams(e),n={},o=t.get(h.view);o&&Na.includes(o)&&(n.view=o);let a=t.get(h.day);a&&R.includes(a)&&(n.day=a);let s=Number(t.get(h.radius));t.has(h.radius)&&Number.isFinite(s)&&s>0&&(n.radius=s),t.get(h.weight)==="riders"?n.weight="riders":t.get(h.weight)==="locations"&&(n.weight="locations"),t.get(h.surfaceUnit)==="people"?n.surfaceUnit="people":t.get(h.surfaceUnit)==="area"&&(n.surfaceUnit="area");let r=t.get(h.oneSeatDay);r===ut.selected?n.oneSeatRestricted=!0:r===ut.any&&(n.oneSeatRestricted=!1);let i=t.get(h.dest);if(i&&i!==ei){let _=ja(i);_?n.dest=_:i.includes(",")||(n.dest={key:i})}let u=ja(t.get(h.at));u&&(n.at=u);let d=ti(t.get(h.camera));d&&(n.camera=d);let m=t.get(h.place);m&&(n.place=m);let b=t.get(h.selection);b!==null&&(n.selection=b.split(",").filter(_=>Zr.test(_)));let k=t.get(h.placeFill);return(k==="lost"||k==="gained"||k==="service")&&(n.placeFill=k),n}function fn(e){return`${e.lat.toFixed(Ia)},${e.lon.toFixed(Ia)}`}function ja(e){let t=Ya(e,2);return t?{lat:t[0],lon:t[1]}:null}function ti(e){let t=Ya(e,3);return t?{lat:t[0],lon:t[1],zoom:t[2]}:null}function Ya(e,t){if(!e)return null;let n=e.split(",").map(Number);return n.length!==t||!n.every(Number.isFinite)?null:n}var bn="embed";var ni=["1","true","yes"];function za(e){let t=new URLSearchParams(e).get(bn);return t!==null&&ni.includes(t.toLowerCase())}function Va(e){let t=new URLSearchParams(e);return t.set(bn,"1"),`?${t}`}function Ka(e){let t=new URLSearchParams(e);t.delete(bn);let n=String(t);return n?`?${n}`:""}function Wa(e){return(e?`Full answer for ${e}`:"Open the full map")+" \u2197"}var W=["peek","half","full"],oi=192,ai=.3,si=.55,ri=.9,ii=.6,li=.45;function dt(e,t){return e==="peek"?Math.min(oi,t*ai):e==="half"?t*si:t*ri}function ci(e,t,n=0){let o=W.map(s=>Math.abs(dt(s,t)-e)),a=o.indexOf(Math.min(...o));return Math.abs(n)>ii&&(a=Math.max(0,Math.min(W.length-1,a+(n>0?1:-1)))),W[a]}function qa(e){return W[(W.indexOf(e)+1)%W.length]}function ui(e,t){return Math.min(e,t*li)}function le(){return getComputedStyle(document.documentElement).getPropertyValue("--compact").trim()==="1"}function vn(e){let t=null,n=()=>{let o=le();o!==t&&(t=o,e(o))};return window.addEventListener("resize",n),n(),n}var di=8,pi=400;function Xa(e){let t=c("side"),n=c("sheet-handle"),o="peek",a=!1,s=0,r=0,i=0,u={y:0,t:0};function d(){return window.innerHeight}function m(y){t.style.height=`${y}px`,e.onMove(y,ui(y,d()))}function b(y){o=y,t.dataset.snap=y,m(dt(y,d()))}n.addEventListener("pointerdown",y=>{le()&&(a=!0,s=y.clientY,r=t.getBoundingClientRect().height,i=y.timeStamp,u={y:y.clientY,t:y.timeStamp},t.classList.add("dragging"),n.setPointerCapture(y.pointerId))}),n.addEventListener("pointermove",y=>{if(!a)return;let De=r+(s-y.clientY),J=dt("peek",d()),x=dt("full",d());m(Math.max(J,Math.min(x,De))),u={y:y.clientY,t:y.timeStamp}});function k(y){if(!a)return;if(a=!1,t.classList.remove("dragging"),!(Math.abs(y.clientY-s)>di)&&y.timeStamp-i<pi){b(qa(o));return}let J=y.timeStamp-u.t,x=J>0?(u.y-y.clientY)/J:0;b(ci(t.getBoundingClientRect().height,d(),x))}n.addEventListener("pointerup",k),n.addEventListener("pointercancel",k),n.addEventListener("keydown",y=>{y.key!=="Enter"&&y.key!==" "||(y.preventDefault(),le()&&b(qa(o)))});let _=vn(e.onLayoutChange);function U(){if(_(),!le()){t.style.height="",t.removeAttribute("data-snap"),e.onMove(0,0);return}b(o)}return window.addEventListener("resize",U),U(),{at:()=>le()?o:"full",atLeast(y){le()&&W.indexOf(y)>W.indexOf(o)&&b(y)}}}var mi=[-79.9959,40.4406],gi=12,yi="#e2574c",D={radius:"data-radius",day:"data-day",oneSeatDay:"data-oneseat-day",view:"data-view",dest:"data-dest",placeFill:"data-place-fill"},xe=Ga(location.search),Re=za(location.search);Re&&c("app").classList.add("embed");var hi={at:()=>"full",atLeast(){}},es=null,P=400,_e=null,f=null,ue=null,te=0,$={key:"downtown"},Z=null,ts=!1,me=!1,ft="locations",ge="area",ns="count",ht=null,F=ie,H=!1,g="dots",os,Ln=[],l=new maplibregl.Map({container:"map",style:"https://tiles.openfreemap.org/styles/positron",center:xe.camera?[xe.camera.lon,xe.camera.lat]:mi,zoom:xe.camera?.zoom??gi,cooperativeGestures:Ua(window),attributionControl:{compact:!0}});l.addControl(new maplibregl.NavigationControl,"top-right");l.on("load",()=>{Tn(l),vo(l),Do(l,Ge),Fo(l,Ge),Jo(l,"walk-fill"),ma(l),Ra(l,Ge),N(),l.on("click",t=>{if(H)return;if(ts){Pe({lat:t.lngLat.lat,lon:t.lngLat.lng});return}if(g==="places"){let s=l.queryRenderedFeatures(t.point,{layers:[A]})[0];s&&mt(s.properties.key);return}let n=[...Ft,"oneseat-dots"].filter(s=>l.getLayoutProperty(s,"visibility")!=="none"),o=l.queryRenderedFeatures(t.point,{layers:n})[0],a=o?o.geometry.coordinates:[t.lngLat.lng,t.lngLat.lat];xn(a[1],a[0])}),l.on("mouseenter",A,()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave",A,()=>{l.getCanvas().style.cursor=""});let e=new maplibregl.Popup({closeButton:!1,offset:8});for(let t of Ft)l.on("mouseenter",t,()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave",t,()=>{l.getCanvas().style.cursor="",e.remove()}),l.on("mousemove",t,n=>{let o=n.features?.[0],a=Nt();!o||!a||e.setLngLat(o.geometry.coordinates).setHTML(Lo(o.properties,L(),a.buckets)).addTo(l)});l.on("mouseenter","oneseat-dots",()=>{l.getCanvas().style.cursor="pointer"}),l.on("mouseleave","oneseat-dots",()=>{l.getCanvas().style.cursor="",e.remove()}),l.on("mousemove","oneseat-dots",t=>{let n=t.features?.[0],o=se();!n||!o||e.setLngLat(n.geometry.coordinates).setHTML(Ko(n.properties,o)).addTo(l)}),l.on("mouseleave",A,()=>e.remove()),l.on("mousemove",A,t=>{let n=t.features?.[0];n&&e.setLngLat(t.lngLat).setHTML(Fa(n.properties,F,L())).addTo(l)}),Ti(),l.on("moveend",()=>{let t=l.getCenter();es={lat:t.lat,lon:t.lng,zoom:l.getZoom()},v(),B()}),ce(D.radius,t=>{P=Number(t.dataset.radius),jt(l,P,L()).then(v),Ve()&&Vt(l,P,L()).then(v),Ke()&&qt(P).then(v),se()&&gt(),f&&de(f.lat,f.lon)}),ce(D.day,t=>{let n=t.dataset.day;Vn(n),g!=="journey"&&N(),Ut(l,n),Kt(l,n),g==="journey"&&f&&$n(f.lat,f.lon),Qe()&&No(l,n).then(v),me&&se()&&(gt(),f&&de(f.lat,f.lon)),ke()&&F==="service"&&ct(l,F,n),v()}),ce(D.oneSeatDay,t=>{me=t.dataset.oneseatDay==="selected",Sn(),gt(),f&&de(f.lat,f.lon)}),ce(D.view,t=>{let n=g;g=t.dataset.view,e.remove(),oo(l,g==="dots"||g==="both"),Li(g==="surface"||g==="both"),ki(g==="corridors"),Ri(g==="oneseat"),Pi(g==="journey",n==="journey"),_i(g==="places"),g!=="journey"&&n!=="journey"&&(g==="oneseat"||n==="oneseat")&&N({scrollToTop:!0}),xi(g!=="corridors"&&g!=="journey"&&g!=="places");let o=g==="oneseat"||g==="journey";c("dest-controls").classList.toggle("hidden",!o),c("oneseat-day-controls").classList.toggle("hidden",g!=="oneseat"),c("place-fill-controls").classList.toggle("hidden",g!=="places"),ye()||Qa(!1),pe(),Sn(),o||yt(!1),ss()}),ce(D.dest,t=>{let n=t.dataset.dest;if(n==="pin"){yt(!0);return}yt(!1),Pe({key:n})}),ce(D.placeFill,t=>{F=t.dataset.placeFill,ke()&&ct(l,F,L()),N(),v(),Sn()}),c("legend").addEventListener("click",t=>{let n=t.target.closest("[data-weight]");if(n){ft=n.dataset.weight,v(),B();return}let o=t.target.closest("[data-surface-unit]");if(o){ge=o.dataset.surfaceUnit,$i(ge),B();return}let a=t.target.closest("[data-bucket]");a&&(wo(l,a.dataset.bucket,L()),v())}),c("legend-reset").addEventListener("click",()=>{So(l,L()),v()}),c("legend-select").addEventListener("click",()=>Qa(!H)),c("legend-clear").addEventListener("click",()=>{Bt(l),pe(),v(),B()}),c("legend-collapse").addEventListener("click",()=>{wn(!c("legend-box").classList.contains("collapsed"))}),c("panel").addEventListener("click",t=>{let n=t.target.closest("[data-goto-dest]");n&&Pe({key:n.dataset.gotoDest});let o=t.target.closest("[data-caveat]");o&&Ai(o.dataset.caveat);let a=t.target.closest("[data-select-place]");a&&mt(a.dataset.selectPlace);let s=t.target.closest("[data-sort-places]");s&&(ns=s.dataset.sortPlaces,N());let r=t.target.closest("[data-goto-place]");r&&(g!=="places"&&ee(D.view,"places"),mt(r.dataset.gotoPlace))}),c("side-toggle").addEventListener("click",wi),Re&&vn(wn),os=Re?hi:Xa({onMove(t,n){document.documentElement.style.setProperty("--sheet-h",`${t}px`),l.setPadding({top:0,right:0,bottom:n,left:0})},onLayoutChange:wn}),bi(),vt(),pe(),bt(),fi(xe)||jt(l,P,L()).then(v),Mi(),Ci()});function ce(e,t){let n=`[${e}]`;document.querySelectorAll(n).forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(n).forEach(a=>a.classList.toggle("active",a===o)),t(o),vt(),B()})})}function ee(e,t){let n=document.querySelector(`[${e}="${t}"]`);return n?.click(),n!==null}function fi(e){let t=!1;return e.radius!==void 0&&(t=ee(D.radius,String(e.radius))||t),e.day&&(t=ee(D.day,e.day)||t),e.oneSeatRestricted!==void 0&&ee(D.oneSeatDay,e.oneSeatRestricted?"selected":"any"),e.weight&&(ft=e.weight),e.surfaceUnit&&(ge=e.surfaceUnit),e.placeFill&&ee(D.placeFill,e.placeFill),e.dest&&("key"in e.dest?ee(D.dest,e.dest.key):Pe(e.dest)),e.selection&&uo(l,e.selection),e.view&&ee(D.view,e.view),e.at&&xn(e.at.lat,e.at.lon),e.place&&mt(e.place),t}function B(){let e={view:g,day:L(),radius:P,oneSeatRestricted:me,weight:ft,surfaceUnit:ge,dest:$,at:f,camera:es,place:ht,placeFill:F,selection:io()},t=Ja(e);history.replaceState(null,"",(Re?Va(t):t)+location.hash),bt(t)}function bt(e=Ka(location.search)){if(!Re)return;let t=c("embed-link");t.href=`${location.pathname}${e}${location.hash}`;let n=f?ue?ve(ue):"this point":null;t.querySelector(".el-action").textContent=Wa(n)}function vt(){c("statebar").innerHTML=Ba({view:g,day:L(),radius:P,oneSeatRestricted:me,destination:Oe()}),vi()}function wn(e){c("legend-box").classList.toggle("collapsed",e);let t=c("legend-collapse");t.textContent=e?"+":"\u2013",t.title=e?"Show the key":"Collapse the key",t.setAttribute("aria-expanded",String(!e))}function bi(){let e=t=>{c("app").classList.toggle("controls-open",t),c("controls-toggle").setAttribute("aria-expanded",String(t))};c("controls-toggle").addEventListener("click",()=>{e(!c("app").classList.contains("controls-open"))}),c("controls-scrim").addEventListener("click",()=>e(!1)),document.addEventListener("keydown",t=>{t.key==="Escape"&&e(!1)})}function vi(){c("controls-toggle").firstChild?.remove(),c("controls-toggle").prepend(document.createTextNode(Ha(g)))}function wi(){let e=c("app").classList.toggle("side-collapsed"),t=c("side-toggle");t.textContent=e?"\u203A":"\u2039",t.title=e?"Show the panel":"Hide the panel",t.setAttribute("aria-expanded",String(!e)),l.resize()}function v(){Si()}function Si(){if(c("legend-reset").classList.toggle("hidden",Qt()||nn()||cn()||ke()||!ye()),cn()){c("legend").innerHTML=ba(st());return}if(ke()){c("legend").innerHTML=Aa({selected:ka(),fill:F,day:L(),boundaries:gn(),unchanged:_a()});return}if(Qt()){let n=Qe();n&&Qo(c("legend"),n);return}if(nn()){let n=se();if(!n)return;let o=l.getBounds();Zo(c("legend"),n,{west:o.getWest(),south:o.getSouth(),east:o.getEast(),north:o.getNorth()});return}let e=Nt();if(!e)return;let t=l.getBounds();ta(c("legend"),{layer:e,day:L(),bounds:{west:t.getWest(),south:t.getSouth(),east:t.getEast(),north:t.getNorth()},weight:ft,dots:ye(),surface:zt()?Ve():null,unit:ge,population:Ke(),selection:ro()})}async function Li(e){if(e&&!Ve()){c("legend").classList.add("loading");try{await Vt(l,P,L())}finally{c("legend").classList.remove("loading")}}Eo(l,e),e&&ge==="people"&&await as(),v()}async function as(){if(!Ke()){c("legend").classList.add("loading");try{await qt(P)}finally{c("legend").classList.remove("loading")}}}async function $i(e){e==="people"&&zt()&&await as(),v()}async function ki(e){if(e&&!Qe()){c("legend").classList.add("loading");try{await Zt(l,L())}finally{c("legend").classList.remove("loading")}}Ho(l,e),v()}async function _i(e){if(e&&(!mn()||!gn())){c("legend").classList.add("loading");try{await Promise.all([Oa(),Da(l)])}finally{c("legend").classList.remove("loading")}}Ta(l,e),e&&ct(l,F,L()),e&&N(),v()}async function mt(e){ht=await _n(()=>Ea(l,e))?e:null,g==="places"&&(N(),ht&&document.querySelector(`[data-select-place="${CSS.escape(e)}"]`)?.scrollIntoView({block:"nearest"})),v(),B()}function xi(e){document.querySelectorAll("[data-radius]").forEach(t=>{t.disabled=!e})}function N({scrollToTop:e=!1}={}){if(e&&(c("panel").scrollTop=0),bt(),g==="places"){c("panel").innerHTML=Ca(mn()??[],ns,ht,F);return}if(!ue){g==="oneseat"?c("panel").innerHTML=Zn(Oe()):Kn(c("panel"));return}if(g==="oneseat"){let t=Qn(ue,$,L());if(t){c("panel").innerHTML=t;return}}Xn(ue)}function Pi(e,t=!1){if(ga(l,e),v(),!e){t&&(f?de(f.lat,f.lon):N());return}st()&&f?c("panel").innerHTML=dn(st(),Oe()):c("panel").innerHTML=fa(Oe())}async function $n(e,t){let n=++te;f={lat:e,lon:t},B(),is(e,t);let o=rs(),a=p(Oe());if(!o){c("panel").innerHTML=`<div class="empty"><h2>No destination yet</h2>
    ...
    <p class="muted">Routing both networks from this point to
       ${a}, at two transfer distances. A few seconds.</p></div>`;try{let s=await S(ya({lat:e,lon:t},o,L()));if(n!==te)return;un(l,s),c("panel").innerHTML=dn(s,a),v(),bt()}catch(s){if(n!==te)return;un(l,null),c("panel").innerHTML=`<div class="empty"><h2>No answer for that point</h2>
       <p class="muted">${s.message}</p></div>`}}function Sn(){c("day-controls").classList.toggle("hidden",!zo(g,me,F))}function kn(){return Yo(me,L())}async function Ri(e){e&&!se()&&await _n(()=>on(l,P,$,kn())),Vo(l,e),v()}async function gt(){await _n(()=>on(l,P,$,kn())),v()}async function _n(e){c("legend").classList.add("loading");try{return await e()}finally{c("legend").classList.remove("loading")}}function Pe(e){if($=e,yt(!1),Oi(),ss(),vt(),B(),g==="journey"){f&&$n(f.lat,f.lon),v();return}f?de(f.lat,f.lon):N({scrollToTop:!0}),gt()}function ss(){let e=rs();if(!(e!==null&&(g==="journey"||g==="oneseat"&&"lat"in $))){Z?.remove(),Z=null;return}Z?Z.setLngLat([e.lon,e.lat]).addTo(l):(Z=new maplibregl.Marker({color:tn,draggable:!0}).setLngLat([e.lon,e.lat]).addTo(l),Z.on("dragend",()=>{let n=Z.getLngLat();Pe({lat:n.lat,lon:n.lng})}))}function Oi(){let e=Go($);document.querySelectorAll("[data-dest]").forEach(t=>{t.classList.toggle("active",t.dataset.dest===e)})}function rs(){if("lat"in $)return{lat:$.lat,lon:$.lon};let e=$.key,t=Ln.find(n=>n.key===e);return t?{lat:t.lat,lon:t.lon}:null}function Oe(){if("lat"in $)return`${$.lat.toFixed(4)}, ${$.lon.toFixed(4)}`;let e=$.key;return Ln.find(t=>t.key===e)?.name??e}function yt(e){ts=e,l.getCanvas().style.cursor=e?"crosshair":"",document.querySelectorAll('[data-dest="pin"]').forEach(t=>{t.classList.toggle("armed",e),t.textContent=e?"click the map\u2026":"Pick a point"})}async function de(e,t){let n=++te;f={lat:e,lon:t},B(),c("panel").classList.add("loading"),is(e,t);try{let o="lat"in $?`&dest_lat=${$.lat.toFixed(6)}&dest_lon=${$.lon.toFixed(6)}`:"",a=await S(`/api/place?lat=${e.toFixed(6)}&lon=${t.toFixed(6)}&radius=${P}${o}&oneseat_day=${kn()}`);if(n!==te)return;Cn(l,e,t,P,a.current.stops,a.proposed.stops),Di(),ue=a,N({scrollToTop:!0})}catch(o){if(n!==te)return;c("panel").innerHTML=`<div class="empty"><h2>No answer for that point</h2>
       <p class="muted">${o.message}</p></div>`}finally{n===te&&c("panel").classList.remove("loading")}}function Di(){c("pin-key").innerHTML=ea(P),c("pin-key").classList.remove("hidden")}function is(e,t){_e?_e.setLngLat([t,e]):(_e=new maplibregl.Marker({color:yi,draggable:!0}).setLngLat([t,e]).addTo(l),_e.on("dragend",()=>{let n=_e.getLngLat();xn(n.lat,n.lng)}))}var pt=14;function ye(){return g==="dots"||g==="both"}function Qa(e){H=e&&ye(),H?l.dragPan.disable():l.dragPan.enable(),l.getCanvas().style.cursor=H?"none":"",H||ls(),pe()}function pe(){let e=c("legend-select");e.classList.toggle("hidden",!ye()),e.setAttribute("aria-pressed",String(H)),e.textContent=H?"Selecting":"Select stops",c("legend-clear").classList.toggle("hidden",!ye()||!lo())}function Ei(e,t){let n=c("brush");n.style.left=`${e}px`,n.style.top=`${t}px`,n.hidden=!H}function Za(e){c("brush").classList.toggle("painting",e)}function ls(){c("brush").hidden=!0}function Ti(){let e=c("brush");e.style.width=`${pt*2}px`,e.style.height=`${pt*2}px`;let t=!1,n=!1,o=!1,a=()=>{o||(o=!0,requestAnimationFrame(()=>{o=!1,pe(),v()}))},s=()=>{H&&(t=!0,n=!1,Za(!0))},r=u=>{if(Ei(u.point.x,u.point.y),!t)return;n=!0,Ht(l,It(l,u.point.x,u.point.y,pt))&&a()},i=u=>{if(Za(!1),!!t){if(t=!1,!n){let[d]=It(l,u.point.x,u.point.y,pt);d&&co(l,d)}pe(),v(),B()}};l.on("mousedown",s),l.on("mousemove",r),l.on("mouseup",i),l.getCanvas().addEventListener("mouseleave",ls),l.on("touchstart",s),l.on("touchmove",r),l.on("touchend",i)}function xn(e,t){if(os.atLeast("half"),g==="journey"){$n(e,t);return}g!=="places"&&de(e,t)}async function Ci(){try{Ln=await S("/api/destinations"),vt()}catch{}}async function Mi(){try{let e=await S("/api/meta"),t=`today: ${e.feeds.current_feed_version||"current GTFS"} \xB7 proposed: ${e.feeds.proposed_feed_version||"proposed-network feed"}`;c("feedline").textContent=t,c("feedline-methods").textContent=t,c("caveats").innerHTML=e.caveats.map(n=>`<li id="caveat-${n.id}">${n.text}</li>`).join("")}catch{}}function Ai(e){c("methods").classList.add("open");let t=document.getElementById(`caveat-${e}`);t&&(t.scrollIntoView({block:"center"}),t.classList.remove("asked"),t.offsetWidth,t.classList.add("asked"))}c("methods-open").addEventListener("click",()=>c("methods").classList.add("open"));c("methods-close").addEventListener("click",()=>c("methods").classList.remove("open"));})();
