"use strict";(()=>{function d(e){let t=document.getElementById(e);if(!t)throw new Error(`missing element #${e}`);return t}async function P(e){let t=await fetch(e);if(!t.ok){let n=t.statusText;try{n=(await t.json()).detail??n}catch{}throw new Error(n)}return t.json()}var vn=new Map;function K(e){let t=vn.get(e);if(t)return t;let n=P(e).catch(o=>{throw vn.delete(e),o});return vn.set(e,n),n}function u(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function fe(e){if(e==null)return"\u2014";let t=e%1440,n=Math.floor(t/60),o=Math.round(t%60),r=n<12?"am":"pm";return`${n%12===0?12:n%12}:${String(o).padStart(2,"0")}${r}`}function wn(e){if(e==null)return"\u2014";let t=Math.floor(e/60),n=Math.round(e%60);return t?`${t}h ${String(n).padStart(2,"0")}m`:`${n}m`}function Rn(e){return e>0?`+${e}`:String(e)}function or(e,t){return e?`${t>=e?"+":""}${((t-e)/e*100).toFixed(1)}%`:t?"new":"\u2014"}var el="#15181e",rr="#ffa23a",tl="#ffffff";function nl(e,t,n,o=96){let r=[],s=n/111320,a=n/(111320*Math.cos(e*Math.PI/180));for(let i=0;i<=o;i++){let c=i/o*2*Math.PI;r.push([t+a*Math.cos(c),e+s*Math.sin(c)])}return{type:"Feature",geometry:{type:"Polygon",coordinates:[r]},properties:{}}}function W(e){return{type:"FeatureCollection",features:e}}function ol(e){return e.filter(t=>t.moved_m!=null).map(t=>({type:"Feature",geometry:{type:"LineString",coordinates:[[t.moved_lon,t.moved_lat],[t.lon,t.lat]]},properties:{stop_id:t.stop_id,moved_m:t.moved_m}}))}function rl(e,t){let n=e.side==="current"?"today":"proposed",o=e.moved_m!=null?`<br>moved ${e.moved_m} m from where it stands today`:"",r=t?`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,.18)">${t}</div>`:"";return`<b>${e.name}</b><br>${n} \xB7 stop ${e.stop_id}${o}${r}`}function Ln(e){return e!=="corridors"&&e!=="journey"&&e!=="places"&&e!=="routes"}function $n(e){for(let t of["walk","stops-now","stops-prop","stop-moves"])e.getSource(t)?.setData(W([]))}function sr(e,t){return e.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n.lon,n.lat]},properties:{...n,side:t}}))}function ar(e){e.addSource("walk",{type:"geojson",data:W([])}),e.addSource("stops-now",{type:"geojson",data:W([])}),e.addSource("stops-prop",{type:"geojson",data:W([])}),e.addSource("stop-moves",{type:"geojson",data:W([])}),e.addLayer({id:"walk-fill",type:"fill",source:"walk",paint:{"fill-color":"#8fb7ff","fill-opacity":.12}}),e.addLayer({id:"walk-line",type:"line",source:"walk",paint:{"line-color":"#8fb7ff","line-width":1.5,"line-dasharray":[2,2]}}),e.addLayer({id:"stop-moves-l",type:"line",source:"stop-moves",paint:{"line-color":rr,"line-width":1.5,"line-dasharray":[2,2]}}),e.addLayer({id:"stops-prop-c",type:"circle",source:"stops-prop",paint:{"circle-radius":7,"circle-color":tl,"circle-stroke-width":3,"circle-stroke-color":rr}}),e.addLayer({id:"stops-now-c",type:"circle",source:"stops-now",paint:{"circle-radius":4,"circle-color":el,"circle-stroke-width":1,"circle-stroke-color":"rgba(255,255,255,.9)"}})}function ir(e){return["stops-now-c","stops-prop-c"].map(t=>({layer:t,html:(n,o=[])=>rl(n.properties,e(o))}))}function lr(e,t,n,o,r,s){e.getSource("walk").setData(W([nl(t,n,o)])),e.getSource("stops-now").setData(W(sr(r,"current"))),e.getSource("stops-prop").setData(W(sr(s,"proposed"))),e.getSource("stop-moves").setData(W(ol(s)))}var x=["weekday","saturday","sunday"],kn=["early_4_6a","am_6_9a","mid_9a_3p","pm_3_6p","eve_6_8p","late_8_11p","owl_11p_4a"],cr={early_4_6a:"4\u20136am",am_6_9a:"6\u20139am",mid_9a_3p:"9am\u20133pm",pm_3_6p:"3\u20136pm",eve_6_8p:"6\u20138pm",late_8_11p:"8\u201311pm",owl_11p_4a:"11pm\u20134am"},lt=4,ct=6,ur=e=>ct+lt*e,dr=e=>ct+1+lt*e,Be=e=>ct+2+lt*e,sl=e=>ct+3+lt*e,ut=2,al=3,Ie=4,pr=5,he=e=>e[al],M=(e,t)=>e[t],mr=(e,t)=>e[sl(t)],_n=e=>2+2*e,xn=e=>3+2*e,dt=4,gr=e=>2+dt*e,fr=e=>3+dt*e,hr=e=>4+dt*e,yr=e=>5+dt*e;var il=[[.3963377774,.2158037573],[-.1055613458,-.0638541728],[-.0894841775,-1.291485548]],ll=[[4.0767416621,-3.3077115913,.2309699292],[-1.2684380046,2.6097574011,-.3413193965],[-.0041960863,-.7034186147,1.707614701]],br=1e-6,cl=32;function wr(e,t,n){let o=n*Math.PI/180,r=t*Math.cos(o),s=t*Math.sin(o),a=il.map(([i,c])=>(e+i*r+c*s)**3);return ll.map(i=>i[0]*a[0]+i[1]*a[1]+i[2]*a[2])}function Sr(e,t,n){return wr(e,t,n).every(o=>o>=-br&&o<=1+br)}function ul(e,t,n){if(Sr(e,t,n))return t;let o=0,r=t;for(let s=0;s<cl;s++){let a=(o+r)/2;Sr(e,a,n)?o=a:r=a}return o}function dl(e){let t=Math.min(1,Math.max(0,e)),n=t<=.0031308?12.92*t:1.055*t**(1/2.4)-.055;return Math.round(Math.min(1,Math.max(0,n))*255)}function pl(e,t,n){let[o,r,s]=wr(e,ul(e,t,n),n);return`#${[o,r,s].map(a=>dl(a).toString(16).padStart(2,"0")).join("")}`}var vr=/(\d+)/;function ml(e,t){let n=e.split(vr),o=t.split(vr);for(let r=0;r<Math.max(n.length,o.length);r++){let s=n[r]??"",a=o[r]??"";if(s!==a)return r%2?Number(s)-Number(a):s<a?-1:1}return 0}function Ue(e){let t=[...new Set(e)].sort(ml);return new Map(t.map((n,o)=>[n,pl(.55,.16,o*360/t.length)]))}var Rr="at this stop",Lr=e=>`within ${e} m`,gl="both directions",fl="one or both directions",Dn="weekday";function w(){return Dn}function Dr(e){Dn=e}function Pr(e){e.innerHTML=`
    ...
    <div class="empty">
    ...
    </div>`}var X={gone:{color:"#e8232f",size:6},halved:{color:"#ef5c33",size:4.5},less:{color:"#b06a55",size:3},same:{color:"#6b7280",size:2.5},more:{color:"#996cb4",size:3},doubled:{color:"#bd60e7",size:4.5},new:{color:"#0f79c9",size:6},none:{color:"#3a3f4a",size:2}},ye="change",Z="change-dots",ae=["boolean",["feature-state","selected"],!1],Gr="#15181e",ie=["==",["get","published"],0],ft="newplace",Nl="#15181e",Hl=5,gt=["==",["get","removed"],1],ht="removedstop",We="change-removed",Cn="change-removed-selected",Tn="removed-cross",Kr="#e8232f";function Bl(e=2){let t=16*e,n=document.createElement("canvas");n.width=t,n.height=t;let o=n.getContext("2d"),r=t*.2;o.lineCap="round";for(let[s,a]of[[t*.26,"rgba(255,255,255,.95)"],[t*.14,Kr]])o.lineWidth=s,o.strokeStyle=a,o.beginPath(),o.moveTo(r,r),o.lineTo(t-r,t-r),o.moveTo(t-r,r),o.lineTo(r,t-r),o.stroke();return o.getImageData(0,0,t,t)}var mt=null,q=new Set,U=new Set,Il=[Z,Cn,We],yt=[Z,We],Ye=Z;function Wr(e,t){for(let n of Il)e.getLayer(n)&&e.setLayoutProperty(n,"visibility",t?"visible":"none")}function bt(){return mt}function Ve(e){return q.has(e)}function Yr(e,t,n,o){return r=>Gl(r,e,t,n,o)}function Vr(e){return t=>e.has(he(t))}function zr(){return U}function qr(){return[...U].sort()}function Xr(){return U.size}function An(e,t){let n=0;for(let o of t)U.has(o)||(U.add(o),Ke(e,o,!0),n++);return n}function Zr(e,t){U.delete(t)?Ke(e,t,!1):(U.add(t),Ke(e,t,!0))}function Qr(e,t){Fn(e),An(e,t)}function Fn(e){for(let t of U)Ke(e,t,!1);U.clear()}function Ke(e,t,n){try{e.setFeatureState({source:ye,id:t},{selected:n})}catch{}}function Ul(e){for(let t of U)Ke(e,t,!0)}function jl(e,t,n,o){let r=n*n;return o.filter(s=>(s.x-e)**2+(s.y-t)**2<=r).map(s=>s.id)}function Nn(e,t,n,o){let r=[[t-o,n-o],[t+o,n+o]],s=[Z,We].filter(i=>e.getLayer(i)),a=e.queryRenderedFeatures(r,{layers:s}).filter(i=>i.id!==void 0).map(i=>{let[c,m]=i.geometry.coordinates,p=e.project([c,m]);return{id:i.id,x:p.x,y:p.y}});return jl(t,n,o,a)}function es(e,t,n,o){let r={};for(let s of n)r[s]=0;for(let s of e){if(!o(s)||M(s,ut)===0||M(s,Ie)===1)continue;let a=n[M(s,Be(t))];a!==void 0&&r[a]++}return r}function ts(e,t){let n=0;for(let o of e)t(o)&&M(o,ut)===0&&n++;return n}function ns(e,t){let n=0;for(let o of e)t(o)&&M(o,Ie)===1&&n++;return n}function Gl(e,t,n,o,r){let s=M(e,0),a=M(e,1);return s>=n&&s<=r&&a>=t&&a<=o}function os(e,t,n,o){let r={riders:{},measured:{},unmeasured:0,removedRiders:0,removedMeasured:0};for(let s of n)r.riders[s]=0,r.measured[s]=0;for(let s of e){if(!o(s)||M(s,ut)===0)continue;let a=n[M(s,Be(t))];if(a===void 0)continue;let i=mr(s,t),c=M(s,Ie)===1;if(i===null){a!=="none"&&r.unmeasured++;continue}if(c){r.removedRiders+=i,r.removedMeasured++;continue}r.riders[a]+=i,r.measured[a]++}return r}function Jl(e){let t=e.buckets.map(n=>n.key);return{type:"FeatureCollection",features:e.points.filter(n=>x.some((o,r)=>t[M(n,Be(r))]!=="none")).map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{id:he(n),published:n[2],removed:n[Ie],name:n[pr],moved:e.moved?.[he(n)]??null,replacement:e.replacement?.[he(n)]?.[0]??null,nearestStraight:e.replacement?.[he(n)]?.[1]??null,...Object.fromEntries(x.flatMap((o,r)=>[[`b${r}`,t[M(n,Be(r))]],[`sc${r}`,n[ur(r)]],[`sp${r}`,n[dr(r)]]]))}}))}}function rs(e,t){let n=Object.entries(X).flatMap(([o,r])=>[o,r[t]]);return["match",["get",`b${e}`],...n,X.none[t]]}function ss(e){return["case",ie,"rgba(0,0,0,0)",rs(e,"color")]}function Mn(e){return["case",ie,Hl,rs(e,"size")]}function as(e){return["interpolate",["linear"],["zoom"],9,["*",Mn(e),.45],12,Mn(e),16,["*",Mn(e),1.9]]}function is(e){e.addSource(ye,{type:"geojson",promoteId:"id",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Z,type:"circle",source:ye,paint:{"circle-color":ss(0),"circle-radius":as(0),"circle-opacity":.85,"circle-stroke-color":["case",ae,Gr,ie,Nl,"rgba(255,255,255,.9)"],"circle-stroke-width":["interpolate",["linear"],["zoom"],9,["case",ae,1.6,ie,.9,.5],12,["case",ae,2.4,ie,1.5,1],16,["case",ae,3.2,ie,2.2,1.6]]}},"walk-fill"),e.addLayer({id:Cn,type:"circle",source:ye,filter:gt,paint:{"circle-color":"rgba(0,0,0,0)","circle-stroke-color":Gr,"circle-radius":["interpolate",["linear"],["zoom"],9,3.5,12,6,16,10],"circle-stroke-width":["interpolate",["linear"],["zoom"],9,["case",ae,1.6,0],12,["case",ae,2.4,0],16,["case",ae,3.2,0]]}},"walk-fill"),e.hasImage(Tn)||e.addImage(Tn,Bl(),{pixelRatio:2}),e.addLayer({id:We,type:"symbol",source:ye,filter:gt,layout:{"icon-image":Tn,"icon-size":["interpolate",["linear"],["zoom"],9,.34,12,.55,16,1],"icon-allow-overlap":!0,"icon-ignore-placement":!0}},"walk-fill")}async function Hn(e,t,n){return mt=await K(`/api/change?radius=${t}`),e.getSource(ye).setData(Jl(mt)),Ul(e),Bn(e,n),mt}function Bn(e,t){let n=x.indexOf(t);e.setPaintProperty(Z,"circle-color",ss(n)),e.setPaintProperty(Z,"circle-radius",as(n)),In(e,t)}function ls(e,t,n){q.has(t)?q.delete(t):q.add(t),In(e,n)}function cs(e,t){q.clear(),In(e,t)}function In(e,t){let n=x.indexOf(t),o=["none",...q],r=["case",ie,!q.has(ft),["!",["in",["get",`b${n}`],["literal",o]]]];e.setFilter(Z,["all",["!",gt],r]);let s=["all",gt,!q.has(ht)];e.setFilter(We,s),e.setFilter(Cn,s)}function Kl(e){let t=String(e.id??"").split(":")[1]??"",n=e.moved!=null?`<br>the plan stands this pole ${e.moved} m away`:"";return`<b>${e.name}</b><br>stop ${t}${n}<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,.18)"></div>`}function Un(e,t,n,{pole:o=!0}={}){let r=x.indexOf(t),s=e[`b${r}`],a=e.removed===1,i=e.published===0?"the plan adds a stop here":n.find(L=>L.key===s)?.label??s,c=e[`sc${r}`],m=e[`sp${r}`],p=t==="weekday"?"weekday":t,b=a?`Currently ${c}`:`${c} \u2192 ${m}`;return`${o?Kl(e):""}${Yl(e)}${b} buses per ${p} at this stop<br>${a?"":`<b>${i}</b><br>`}<span style="opacity:.6">click for the full comparison</span>`}var Wl=1.5,Jr=800;function Yl(e){if(e.removed!==1)return"";let t=e.replacement,n=e.nearestStraight,o=t??Jr,r=n!=null&&o>n*Wl?`; the nearest in a straight line is ${Math.round(n).toLocaleString()} m`:"",s=t==null?`no other stop within a ${Jr} m walk${r}`:`nearest stop is a ${Math.round(t).toLocaleString()} m walk${r}`;return`<b style="color:${Kr}">Stop removed</b> \u2014 ${s}<br>`}var jn="surface",vt="surface-fill",us="#6b7280",Gn=[[-2,"#d01c2f"],[-1,"#ef5c33"],[-.138,us],[.138,us],[1,"#bd60e7"],[2,"#961bed"]],C="#e8232f",A="#0f79c9",ds=2,St=null,ps=!1;function wt(){return St}function Jn(){return ps}function ms(e,t){if(e<=0||t<=0)return null;let n=Math.log2(t/e);return Math.max(-ds,Math.min(ds,n))}function gs(e,t){return e<=0&&t<=0?"none":e<=0?"new":t<=0?"gone":"ramp"}function fs(e,t,n,o,r,s,a,i){let c={gone:0,less:0,same:0,more:0,new:0};for(let m of e){let p=a.lat0+(m[1]+.5)*a.dlat,b=a.lon0+(m[0]+.5)*a.dlon;if(p<o||p>s||b<n||b>r)continue;let L=m[_n(t)],v=m[xn(t)],k=gs(L,v);if(k!=="none")if(k==="ramp"){let f=ms(L,v);c[f<-.138?"less":f>.138?"more":"same"]+=i}else c[k]+=i}return c}function Vl(e){let{lat0:t,lon0:n,dlat:o,dlon:r}=e.origin;return{type:"FeatureCollection",features:e.cells.map(s=>{let a=t+s[1]*o,i=a+o,c=n+s[0]*r,m=c+r;return{type:"Feature",geometry:{type:"Polygon",coordinates:[[[c,a],[m,a],[m,i],[c,i],[c,a]]]},properties:Object.fromEntries(x.flatMap((p,b)=>{let L=s[_n(b)],v=s[xn(b)];return[[`k${b}`,gs(L,v)],[`v${b}`,ms(L,v)??0]]}))}})}}function hs(e){return["case",["==",["get",`k${e}`],"gone"],C,["==",["get",`k${e}`],"new"],A,["interpolate",["linear"],["get",`v${e}`],...Gn.flatMap(([t,n])=>[t,n])]]}function be(e,t){return["case",["in",["get",`k${e}`],["literal",["gone","new"]]],t,["interpolate",["linear"],["abs",["get",`v${e}`]],0,t*.45,1,t]]}function ys(e,t){e.addSource(jn,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:vt,type:"fill",source:jn,layout:{visibility:"none"},paint:{"fill-color":hs(0),"fill-antialias":!1,"fill-opacity":["interpolate",["linear"],["zoom"],9,be(0,.85),13,be(0,.62),16,be(0,.45)]}},t)}async function Kn(e,t,n){return St=await K(`/api/surface?radius=${t}`),e.getSource(jn).setData(Vl(St)),Wn(e,n),St}function Wn(e,t){let n=x.indexOf(t);e.setPaintProperty(vt,"fill-color",hs(n)),e.setPaintProperty(vt,"fill-opacity",["interpolate",["linear"],["zoom"],9,be(n,.85),13,be(n,.62),16,be(n,.45)])}function bs(e,t){ps=t,e.setLayoutProperty(vt,"visibility",t?"visible":"none")}var Yn=null;function Rt(){return Yn}async function Vn(e){return Yn=await K(`/api/population?radius=${e}`),Yn}function Ss(e,t,n,o,r,s,a){let i={lost:0,gained:0,kept:0,none:0};for(let c of e){let m=a.lat0+(c[1]+.5)*a.dlat,p=a.lon0+(c[0]+.5)*a.dlon;m<o||m>s||p<n||p>r||(i.lost+=c[gr(t)],i.gained+=c[fr(t)],i.kept+=c[hr(t)],i.none+=c[yr(t)])}return i}var zn="corridor",vs="corridor-lines",Se="#8b929c",zl="#6f7783",$t={lost:C,added:A,kept:Se};var Lt=null,ws=!1;function kt(){return Lt}function qn(){return ws}function ql(e){return{type:"FeatureCollection",features:e.runs.map(t=>({type:"Feature",geometry:{type:"LineString",coordinates:t.geometry},properties:{klass:t.klass,length_m:t.length_m}}))}}function Rs(e){let t=e.kept+e.lost;return{lostPct:t>0?e.lost/t*100:0,addedPct:t>0?e.added/t*100:0}}function Xl(){let e=t=>["match",["get","klass"],"lost",$t.lost,"added",$t.added,t];return["interpolate",["linear"],["zoom"],9,e(zl),14,e(Se)]}function Zl(){let e=["match",["get","klass"],"kept",.85,1];return["interpolate",["linear"],["zoom"],9,["*",e,1.2],13,["*",e,2.6],16,["*",e,6]]}function Ql(){return["match",["get","klass"],"kept",.85,.9]}function Ls(e,t){e.addSource(zn,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:vs,type:"line",source:zn,layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":Xl(),"line-width":Zl(),"line-opacity":Ql()}},t)}async function Xn(e,t){return Lt=await P(`/api/corridors?day=${t}`),e.getSource(zn).setData(ql(Lt)),Lt}async function $s(e,t){x.includes(t)&&await Xn(e,t)}function ks(e,t){ws=t,e.setLayoutProperty(vs,"visibility",t?"visible":"none")}var Qn="#2b3038",_s="#b9bec6",ze={loses:{color:C,size:6},gains:{color:A,size:6},keeps:{color:Se,size:3},here:{color:Qn,size:3.5},none:{color:_s,size:1.8}},xt=["loses","gains","keeps","none","here"],Zn="oneseat",xs="oneseat-dots",_t=null,Es=!1;function ve(){return _t}function eo(){return Es}function Ds(e,t,n,o,r,s){let a={};for(let i of t)a[i]=0;for(let i of e){let c=i[0],m=i[1];if(c<o||c>s||m<n||m>r)continue;let p=t[i[3]];p!==void 0&&a[p]++}return a}function ec(e){let t=e.statuses.map(n=>n.key);return{type:"FeatureCollection",features:e.points.map(n=>({type:"Feature",geometry:{type:"Point",coordinates:[n[1],n[0]]},properties:{status:t[n[3]],current:n[4],proposed:n[5]}}))}}function tc(){return["match",["get","status"],...Object.entries(ze).flatMap(([e,t])=>[e,t.color]),_s]}function nc(){let e=["match",["get","status"],...Object.entries(ze).flatMap(([t,n])=>[t,n.size]),ze.none.size];return["interpolate",["linear"],["zoom"],9,["*",e,.45],12,e,16,["*",e,1.9]]}function Ps(e,t){e.addSource(Zn,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:xs,type:"circle",source:Zn,layout:{visibility:"none"},paint:{"circle-color":tc(),"circle-radius":nc(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function oc(e){return"key"in e?`dest=${encodeURIComponent(e.key)}`:`dest_lat=${e.lat.toFixed(6)}&dest_lon=${e.lon.toFixed(6)}`}var rc="pin";function Os(e){return"key"in e?e.key:rc}var Et="any";function sc(e,t,n){return`radius=${e}&${oc(t)}&day=${n}`}function Ts(e,t){return e?t:Et}function Ms(e,t,n){return e==="places"?n==="service":e!=="oneseat"||t}async function to(e,t,n,o=Et){return _t=await P(`/api/oneseat?${sc(t,n,o)}`),e.getSource(Zn).setData(ec(_t)),_t}function Cs(e,t){Es=t,e.setLayoutProperty(xs,"visibility",t?"visible":"none")}function no(e){let t=e.destination;return t.name?t.name:t.lat!=null&&t.lon!=null?`${t.lat.toFixed(4)}, ${t.lon.toFixed(4)}`:"the destination"}function As(e,t){let n=t.statuses.find(i=>i.key===e.status)?.label??e.status,o=(e.current||"").split(";").filter(Boolean),r=(e.proposed||"").split(";").filter(Boolean),s=i=>i.length?i.join(", "):"none",a=no(t);return e.status==="here"?`<b>at ${a}</b><br><span style="opacity:.6">no one-seat ride needed</span>`:`<b>${n}</b> \u2014 ${a}<br>today: ${s(o)}<br>proposed: ${s(r)}`}var Dt={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},oo={weekday:"weekdays",saturday:"Saturdays",sunday:"Sundays"},ac=new Set(["gone","new"]);function ic(e,t,n){return ac.has(e)?`${t} (${oo[n]})`:t}function lc(e){return e.buckets.filter(t=>t.key!=="none")}var Fs={area:"Ground",people:"People"};function cc(e,t,n){let o=e.cell_m*e.cell_m/1e6,r=fs(e.cells,e.days.indexOf(t),n.west,n.south,n.east,n.north,e.origin,o),s=a=>a.toFixed(a<10?1:0);return`
      <div class="lg-area">
      ...
      <div class="lg-ends" style="margin-top:4px">of ground in view, not of people</div>`}function uc(e,t,n){let o='<div class="lg-ends" style="margin-top:4px">where people live in view \u2014 2020 census, counted at home, not where they board</div>';if(!n)return`<div class="lg-area"><span class="muted">loading\u2026</span></div>${o}`;let r=Ss(n.cells,n.days.indexOf(e),t.west,t.south,t.east,t.north,n.origin),s=a=>Math.round(a).toLocaleString();return`
      <div class="lg-area">
    ...
    </button>`}function yc(e,t){if(!e)return"";let n=Ve(ht);return`
    <button class="lg-row ${n?"off":""}" data-bucket="${ht}"
            aria-pressed="${!n}">
      <i class="lg-cross"></i>
      <span class="lg-lab">the plan removes this stop</span>
      <span class="lg-n">${t}</span>
    </button>`}function bc(e,t,n){return!e&&!t?"":`
    <div class="lg-marks">
      <div class="lg-marks-head">and what happens to the stop itself</div>
      ${hc(e)}
      ${yc(t,n)}
    </div>`}function js(e,t){let{layer:n,day:o,bounds:r,weight:s,surface:a,unit:i="area",population:c,selection:m,dots:p=!0}=t,b=n.buckets.map($=>$.key),L=n.days.indexOf(o),{west:v,south:k,east:f,north:T}=r,H=lc(n),R=m&&m.size>0?m:null,it=R?Vr(R):Yr(v,k,f,T),tr=es(n.points,L,b,it),yn=ts(n.points,it),bn=ns(n.points,it),B=s==="riders"?os(n.points,L,b,it):null,Vi=$=>B?B.measured[$]?Math.round(B.riders[$]).toLocaleString():"\u2014":tr[$].toLocaleString(),zi=B?B.removedMeasured?Math.round(B.removedRiders).toLocaleString():"\u2014":bn.toLocaleString(),qi=R?`at ${R.size.toLocaleString()} selected stop${R.size===1?"":"s"}`:"in view",nr=H.reduce(($,Sn)=>$+tr[Sn.key],0)+yn+bn,Xi=B?`<b>${Math.round(H.reduce(($,Sn)=>$+B.riders[Sn.key],0)+B.removedRiders).toLocaleString()}</b> daily boardings ${qi}`:R?`<b>${nr.toLocaleString()}</b>
         of ${R.size.toLocaleString()} selected stops`:`<b>${nr.toLocaleString()}</b>
         stops in view`,Zi=a?` \xB7 surface: ${n.radius} m walk`:"",Qi=!p&&!!a;e.innerHTML=Qi?`
    <div class="lg-head">
      <b>Surface</b>
    ...
    <div class="lg-head">
      ${Xi}
      <span class="muted">\xB7 ${Dt[o]}${Zi}</span>
    </div>
    ...
    <div class="lg-foot">The stops you painted, not everything on screen \u2014
      ...
      carries it.</div>`:""}`}var we="#4aa3ff",qe="#ffa23a",ro="headline",Pt="journey",Tt="journey-rides",zs="journey-walks",Sc=[Tt,zs],qs=null,Xs=!1;function Mt(){return qs}function so(){return Xs}function vc(e,t){let n=e.radii[t],o=[];for(let r of["current","proposed"]){let s=n[r].itinerary;if(s)for(let a of s.legs){let i=a.from??e.origin,c=a.to??e.destination,m=[[i.lon,i.lat],[c.lon,c.lat]],p=a.path?.length?a.path:m;o.push({type:"Feature",geometry:{type:"LineString",coordinates:p},properties:{side:r,kind:a.kind,route:a.route}})}}return{type:"FeatureCollection",features:o}}function Gs(){return["match",["get","side"],"current",we,"proposed",qe,we]}function Js(e){let t=(n,o)=>["match",["get","side"],"proposed",o*e,n*e];return["interpolate",["linear"],["zoom"],9,t(3.5,2),14,t(7,4)]}function Zs(e,t){e.addSource(Pt,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:Tt,type:"line",source:Pt,filter:["==",["get","kind"],"ride"],layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":Gs(),"line-width":Js(1),"line-opacity":.85}},t),e.addLayer({id:zs,type:"line",source:Pt,filter:["==",["get","kind"],"walk"],layout:{visibility:"none","line-cap":"butt","line-join":"round"},paint:{"line-color":Gs(),"line-width":Js(.6),"line-opacity":.8,"line-dasharray":[1.5,1.5]}},t)}function Qs(e,t){Xs=t;for(let n of Sc)e.setLayoutProperty(n,"visibility",t?"visible":"none")}function ao(e,t){qs=t;let n=t?vc(t,ro):{type:"FeatureCollection",features:[]};e.getSource(Pt).setData(n)}function ea(e,t,n){return`/api/journey?lat=${e.lat.toFixed(6)}&lon=${e.lon.toFixed(6)}&dest_lat=${t.lat.toFixed(6)}&dest_lon=${t.lon.toFixed(6)}&day=${n}`}var Ks=e=>`${e.toFixed(1)} min`;function ta(e){return e==null?"\u2014":e===0?"no change":e>0?`${Ks(e)} slower`:`${Ks(-e)} faster`}function Ws(e,t){return e?e.name?u(e.name):`stop ${u(e.stop_id)}`:t}function wc(e,t){let n=Math.round(e.arrive-e.depart);if(e.kind==="walk"){let o=Ws(e.to,"the destination");return`<div class="jl"><span class="jl-what">walk ${n} min</span>
            <span class="muted">to ${o}</span></div>`}return`<div class="jl"><span class="jl-what">ride
          <span class="route">${u(e.route??"?")}</span> ${n} min</span>
          <span class="muted">to ${Ws(e.to,"the destination")}</span></div>`}function Ys(e,t){let n=[],o=null;for(let r of e.legs){let s=o?Math.round(r.depart-o.arrive):0;s>0&&n.push(`<div class="jl jl-wait"><span class="jl-what">wait ${s} min</span></div>`),n.push(wc(r,t)),o=r}return n.join("")}var Rc={no_origin_coverage:"No bus stops within a walk of this point on one or both networks, so there is no trip to time from here. That is a coverage answer rather than a travel-time one \u2014 the Stop-by-stop and Surface views are where it is measured.",no_dest_coverage:"No bus stops within a walk of the destination on one or both networks, so there is nothing to arrive at. That is a coverage answer rather than a travel-time one \u2014 the Stop-by-stop and Surface views are where it is measured.",no_journey:"Both ends have buses, but no trip connects them inside this window on one or both networks \u2014 within the transfer walk below, and with a change of bus allowed."};function Ot(e){return e.median_min==null?"\u2014":e.median_min.toFixed(1)}function Lc(e){return`
    ...
    </table>`}function $c(e){let t=e.radii.strict,n=t.transfer_walk_m,o=e.sign_flips?`<p class="js-flip"><b>These two disagree about which network is
    ...
    <p class="lg-foot">Rides follow the street the bus drives; dashed sections
      ...
      panel answers at a stricter one too.</p>`}var Ft="off",Xe="stoproutes",aa="stoproutes-lines",co="stoproutes-flow",ia="stoproutes-arrows",kc=[aa,co,ia],lo="stoproutes-arrow",ra=3.5,la=null,ca=!1;function Nt(){return la}function ua(){return ca}function da(e,t){return e!==null&&e[t].length>0}function _c(e,t){let n=t==="current"?e.current:e.proposed,o=Ue(n.map(s=>s.route));return{type:"FeatureCollection",features:n.map(s=>({type:"Feature",geometry:{type:"LineString",coordinates:s.points},properties:{side:t,route:s.route,name:s.name,pattern_id:s.pattern_id,color:o.get(s.route)}}))}}function xc(){return["interpolate",["linear"],["zoom"],9,ra*.6,14,ra]}function Ec(e=2){let t=16*e,n=document.createElement("canvas");n.width=t,n.height=t;let o=n.getContext("2d");o.fillStyle="#ffffff","filter"in o&&(o.filter=`blur(${Math.round(t*.06)}px)`);let r=t*.24;return o.beginPath(),o.moveTo(t-r,t/2),o.lineTo(r,r),o.lineTo(r,t-r),o.closePath(),o.fill(),o.getImageData(0,0,t,t)}function pa(e,t){e.addSource(Xe,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:aa,type:"line",source:Xe,layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":["get","color"],"line-width":xc(),"line-opacity":.85}},t),e.addLayer({id:co,type:"line",source:Xe,layout:{visibility:"none","line-cap":"butt","line-join":"round"},paint:{"line-color":"#ffffff","line-width":1.4,"line-opacity":.5,"line-dasharray":[0,3,4]}},t),e.hasImage(lo)||e.addImage(lo,Ec(),{pixelRatio:2,sdf:!0}),e.addLayer({id:ia,type:"symbol",source:Xe,layout:{visibility:"none","symbol-placement":"line","symbol-spacing":90,"icon-image":lo,"icon-size":["interpolate",["linear"],["zoom"],12,.55,16,.9],"icon-rotation-alignment":"map","icon-allow-overlap":!0,"icon-ignore-placement":!0},paint:{"icon-color":["get","color"]}},t)}function Ht(e,t){ca=t;for(let n of kc)e.setLayoutProperty(n,"visibility",t?"visible":"none");t||ya()}function Le(e,t,n){la=t;let o=t?_c(t,n):{type:"FeatureCollection",features:[]};e.getSource(Xe).setData(o),t||ya()}function ma(e,t){return`/api/kerb_routes?lat=${e.lat.toFixed(6)}&lon=${e.lon.toFixed(6)}&day=${t}`}var Dc={current:"today",proposed:"proposed"};function ga(e){return`<i style="display:inline-block;width:9px;height:9px;border-radius:2px;vertical-align:baseline;background:${u(e.color)}"></i> <b>${u(e.route)}</b>${e.name?` \u2014 ${u(e.name)}`:""}<br><span style="opacity:.75">${Dc[e.side]}</span><br><span style="opacity:.6">arrows: direction of travel</span>`}var Pc=20;function Oc(e,t,n){let o=Math.max(1,Math.floor(n/2)),r=Math.max(1,n-o),s=[];for(let a=0;a<o;a++){let i=a/o*e;s.push([i,t,e-i])}for(let a=0;a<r;a++){let i=a/r*e;s.push([0,i,t,e-i])}return s}var sa=Oc(3,4,24),j=null,Ct=0,At=0,Re=null;function Tc(){return typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion: reduce)").matches}function uo(e){Re&&(j=requestAnimationFrame(uo),!(e-At<1e3/Pc)&&(At=e,Ct=(Ct+1)%sa.length,Re.setPaintProperty(co,"line-dasharray",sa[Ct])))}function fa(){Re&&(document.hidden?j!==null&&(cancelAnimationFrame(j),j=null):j===null&&(At=0,j=requestAnimationFrame(uo)))}function ha(e){Tc()||Re||(Re=e,Ct=0,At=0,document.addEventListener("visibilitychange",fa),j=requestAnimationFrame(uo))}function ya(){j!==null&&(cancelAnimationFrame(j),j=null),document.removeEventListener("visibilitychange",fa),Re=null}var Ut="places",va="places-points",po="places-boundaries",ce="places-fill",ke="lost",Mc=100,Cc={lost:"share_lost",gained:"share_gained"};function ee(e,t){return`service_${e}_${t}`}var wa={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},Ac="Every one of Allegheny County's 1,238,177 residents is in a named place: places are assigned by boundary, not by distance to a labelled stop, so nobody here goes unnamed. Every figure is Allegheny-only and day-free \u2014 losing all buses on any day of the week \u2014 so it does not move with the toolbar's day switch. A place with under 100 residents is shown without a share: a denominator that small cannot carry one.",le={lost:C,gained:A},Bt=null,Q=null,$e=null,Ra=!1,It=null;function mo(){return Bt}function La(){return Q}function $a(){return It}function go(){return $e}function Ze(){return Ra}function Fc(e,t){let n=[...e];return t==="count"?n.sort((o,r)=>r.residents_lost-o.residents_lost):n.sort((o,r)=>(r.share_lost??-1)-(o.share_lost??-1))}function Nc(e){return e.residents_gained>e.residents_lost?"gained":"lost"}function Hc(e){return Math.max(e.residents_lost,e.residents_gained)}var ba=4,Bc=16,Ic=1e3;function Uc(e){let t=Math.min(1,Math.sqrt(e/Ic));return ba+t*(Bc-ba)}function jc(e){return{type:"FeatureCollection",features:e.changed.map(t=>({type:"Feature",geometry:{type:"Point",coordinates:[t.lon,t.lat]},properties:{geoid:t.geoid,klass:Nc(t),residents_lost:t.residents_lost,residents_gained:t.residents_gained,radius:Uc(Hc(t))}}))}}function Gc(){return["match",["get","klass"],"lost",le.lost,"gained",le.gained,le.lost]}function Jc(){return["interpolate",["linear"],["zoom"],9,["*",["get","radius"],.5],12,["get","radius"],16,["*",["get","radius"],1.6]]}var Y=[{max:0,label:"No loss, or too few residents to share",opacity:0},{max:.05,label:"Up to 5%",opacity:.15},{max:.15,label:"5\u201315%",opacity:.35},{max:.3,label:"15\u201330%",opacity:.55},{max:null,label:"Over 30%",opacity:.8}];var V=[{max:10,opacity:0},{max:30,opacity:.3},{max:60,opacity:.55},{max:1/0,opacity:.8}];function ka(e,t){return e==="service"?["step",["abs",["coalesce",["get",ee(t,"pct")],0]],V[0].opacity,V[0].max,V[1].opacity,V[1].max,V[2].opacity,V[2].max,V[3].opacity]:["step",["coalesce",["get",Cc[e]],0],Y[0].opacity,Number.EPSILON,Y[1].opacity,Y[1].max,Y[2].opacity,Y[2].max,Y[3].opacity,Y[3].max,Y[4].opacity]}function _a(e,t){return e==="service"?["case",[">=",["coalesce",["get",ee(t,"pct")],0],0],A,C]:le[e]}function Kc(e,t){let n=ee(t,"now"),o=ee(t,"proposed");return e.features.filter(r=>r.properties[n]===0&&r.properties[o]>0).map(r=>r.properties.place)}var Wc=3;function Yc(e){if(e.length===0)return"";let t=e.slice(0,Wc),n=e.length-t.length,o=t.length<=1?t.join(""):`${t.slice(0,-1).join(", ")} and ${t[t.length-1]}`,r=n>0?`${o} (and ${n} more)`:o;return e.length===1?`1 place gets its first bus and cannot be shown as a percentage: ${r}.`:`${e.length} places get their first bus and cannot be shown as a percentage: ${r}.`}function xa(e,t){e.addSource(po,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:ce,type:"fill",source:po,layout:{visibility:"none"},paint:{"fill-color":_a(ke),"fill-opacity":ka(ke),"fill-outline-color":"rgba(255,255,255,.25)"}},t),e.addSource(Ut,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:va,type:"circle",source:Ut,layout:{visibility:"none"},paint:{"circle-color":Gc(),"circle-radius":Jc(),"circle-opacity":.85,"circle-stroke-color":"rgba(255,255,255,.9)","circle-stroke-width":["interpolate",["linear"],["zoom"],9,.4,12,.9,16,1.5]}},t)}function jt(e,t,n){e.setPaintProperty(ce,"fill-color",_a(t,n)),e.setPaintProperty(ce,"fill-opacity",ka(t,n))}async function Ea(){return Bt||(Bt=await P("/api/places")),Bt}async function Da(e){return $e||($e=await P("/api/boundaries"),e.getSource(po).setData($e)),$e}function Vc(e,t){let n=e?.features.find(o=>o.properties.key===t);return n&&n.properties.changed_block_groups===0?n.properties.place:null}async function Pa(e,t){let n=Vc($e,t);if(n)return Q=null,It=n,e.getSource(Ut)?.setData({type:"FeatureCollection",features:[]}),null;try{Q=await P(`/api/places/${encodeURIComponent(t)}`)}catch{return Q=null,It=null,null}return It=null,e.getSource(Ut).setData(jc(Q)),e.flyTo({center:[Q.lon,Q.lat],zoom:13}),Q}function Oa(e,t){Ra=t,e.setLayoutProperty(va,"visibility",t?"visible":"none"),e.setLayoutProperty(ce,"visibility",t?"visible":"none")}function zc(e,t){let n=e.share_lost==null?`<span class="place-share muted" title="Too few residents here to put a share on: this place's measured population is under 100.">\u2014</span>`:`<span class="place-share muted">${(e.share_lost*100).toFixed(1)}% of the place</span>`;return`
    ...
    </button>`}var qc="Unlike the two residents readings above, this one moves with the toolbar's day switch: it is asking about the plan's actual weekday, Saturday or Sunday service, not residents' day-free losses and gains.";function Ta(e,t,n,o){let r=Fc(e,t).map(s=>zc(s,s.key===n)).join("");return`
    <div class="place-head">
      <h2>Places</h2>
      <div class="muted">${e.length.toLocaleString()} named places the plan changes</div>
    </div>
    <p class="note">${Ac}</p>
    ${o==="service"?`<p class="note">${qc}</p>`:""}
    ...
    <div class="place-list">${r}</div>`}function Ma(e,t){return e?`<div class="lg-head"><b>${u(e.place)}</b>
      ...
      <div class="lg-foot muted">No block group in it loses or gains all
        service. Shaded places are the ones with something to show.</div>`:'<div class="lg-head">Click a place to see its changed block groups</div>'}function Xc(e,t){return e.max===1/0?`Over ${t}%`:`${t}\u2013${e.max}%`}function Zc(e,t,n,o){let r=V.map((c,m)=>({band:c,prevMax:m===0?0:V[m-1].max})).filter(({band:c})=>c.opacity>0).flatMap(({band:c,prevMax:m})=>{let p=Xc(c,m);return[`<div class="lg-row lg-static">
          ...
          <span class="lg-lab">${u(p)} more trips</span></div>`]}).join(""),s=o?Kc(o,n):[],a=Yc(s),i=a?`<div class="lg-foot">${u(a)}</div>`:"";return`
    ${Ma(e,t)}
    ...
    <div class="lg-foot">Fill is coloured by SHARE, not by count of residents
      ...
      it; size is the larger of a block group's losses or gains.</div>`}function Qc(e,t){let n=e[ee(t,"now")],o=e[ee(t,"proposed")],r=e[ee(t,"pct")],s=e[ee(t,"rail_proposed")],a=wa[t];if(o===0&&n>0)return`Loses all buses on ${a} (${n} \u2192 0 trips)${s?"; the T still calls here":""}.`;if(n===0&&o>0)return`Gets its first bus on ${a} (0 \u2192 ${o} trips).`;let i=r==null?"\u2014":`${r>0?"+":""}${r.toFixed(1)}%`;return`${n} \u2192 ${o} trips on ${a} (${i}).`}function Aa(e,t,n){if(t==="service")return`<b>${u(e.place)}</b> <span class="muted">\xB7 ${u(e.kind)}</span><br>
      ${Qc(e,n)}`;let o=Math.round(e.residents_total??0).toLocaleString();if(e.changed_block_groups===0)return`<b>${u(e.place)}</b> <span class="muted">\xB7 ${u(e.kind)}</span><br>
    ...
    ${a.join("<br>")}<br>
    <span class="muted">${o} residents total \xB7 ${e.changed_block_groups} block group${e.changed_block_groups===1?"":"s"} changed</span>`}function Sa(e,t,n){let o=Math.round(t).toLocaleString(),r=n==null?`share withheld \u2014 under ${Mc} residents`:`${(n*100).toFixed(1)}%`;return`${o} ${e} (${r})`}var Ba=["discontinued","new","reshaped","one-to-one"],Ia={discontinued:["discontinued"],new:["new"],reshaped:["split","merged"],"one-to-one":["one-to-one"]},vo=["one-to-one"];function zt(e){return Ba.includes(e)}function wo(e){return Ba.filter(t=>e.includes(t))}var Ro="status",eu={status:"What happened",service:"How much service"};function qt(e){return e==="status"||e==="service"}var Qe=["gone","halved","less","same","more","doubled","new"],Lo={gone:"loses all service",halved:"halved or worse",less:"less service",same:"about the same",more:"more service",doubled:"doubled or better",new:"new service",none:"no service either way"},tu={gone:1.7,halved:1.35,less:1,same:.75,more:1,doubled:1.35,new:1.7,none:.75};function Xt(e){return Qe.includes(e)}function $o(e){return Qe.filter(t=>e.includes(t))}var Fa="#8e44ad",Ua={discontinued:C,new:A,split:Fa,merged:Fa,"one-to-one":Se},ko={discontinued:"discontinued",new:"new",split:"split",merged:"merged","one-to-one":"one-to-one"},nu=["discontinued","new","split","merged","one-to-one"],ou="route-changes",ru=.12,ja=.9,Ga=1,su=/^[cp]:[\w-]{1,64}$/;function Ja(e){return su.test(e)}var xe={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},au={current:"today",proposed:"proposed"},Ka=" \u2192 ",Yt="\u2014";function Gt(e,{named:t=!0}={}){return e.length===0?Yt:e.map(n=>t&&n.name?`${n.route} ${n.name}`:n.route).join(", ")}function et(e,{farSideNamed:t=!0}={}){return e.current.length===0?Gt(e.proposed):e.proposed.length===0?Gt(e.current):`${Gt(e.current)}${Ka}${Gt(e.proposed,{named:t})}`}function Vt(e){if(e===null)return Yt;let t=Math.round(e);return t===0?"0%":t>0?`+${t}%`:`\u2212${Math.abs(t)}%`}function iu(e){let t=Object.fromEntries(nu.map(n=>[n,0]));for(let n of e)t[n.status]+=1;return t}var Wa="routechange",te="routechange-lines",tt="routechange-arrows",Zt="routechange-selected",Qt="routechange-selected-lines",_o="routechange-selected-plan",xo="routechange-selected-arrows",lu=[te,tt,Qt,_o,xo],Eo=[_o,Qt,te],cu=[0,2.5],Na={current:["==",["get","side"],"current"],proposed:["==",["get","side"],"proposed"]},ho="routechange-arrow",fo=2.6,uu=1.5,du=2.8,Ya={bucket:"none",pct_trips:null};function yo(e,t,n,o,r){return{type:"Feature",geometry:{type:"LineString",coordinates:e.points},properties:{key:e.key,side:e.side,route:e.route,name:e.name,status:e.status,pattern_id:e.pattern_id,color:t,sort:n,w:o,bucket:r.bucket,scolor:X[r.bucket].color,sw:tu[r.bucket],pct:r.pct_trips}}}function pu(e){let t=new Map(e.groups.map(o=>[o.key,o.service[e.day]]));return{type:"FeatureCollection",features:e.features.map(o=>yo(o,Ua[o.status],o.status==="one-to-one"?0:1,1,t.get(o.key)??Ya)).sort((o,r)=>o.properties.sort-r.properties.sort)}}function mu(e){let t=e.service[e.day]??Ya;return{type:"FeatureCollection",features:e.features.map(o=>o.side==="current"?yo(o,we,0,du,t):yo(o,qe,1,uu,t)).sort((o,r)=>o.properties.sort-r.properties.sort)}}function gu(e){let t=1/0,n=1/0,o=-1/0,r=-1/0;for(let s of e)for(let[a,i]of s.points)a<t&&(t=a),a>o&&(o=a),i<n&&(n=i),i>r&&(r=i);return Number.isFinite(t)?[[t,n],[o,r]]:null}function fu(e){if(e.length===0)return null;let t=e.flatMap(n=>Ia[n]);return["!",["in",["get","status"],["literal",t]]]}function hu(e){return e.length===0?null:["!",["in",["get","bucket"],["literal",[...e]]]]}var bo={status:{color:"color",width:"w"},service:{color:"scolor",width:"sw"}};function Do(e){let t=n=>["*",["get",bo[e].width],n];return["interpolate",["linear"],["zoom"],9,t(fo*.5),14,t(fo),16,t(fo*1.6)]}function yu(e=2){let t=16*e,n=document.createElement("canvas");n.width=t,n.height=t;let o=n.getContext("2d");o.fillStyle="#ffffff","filter"in o&&(o.filter=`blur(${Math.round(t*.06)}px)`);let r=t*.24;return o.beginPath(),o.moveTo(t-r,t/2),o.lineTo(r,r),o.lineTo(r,t-r),o.closePath(),o.fill(),o.getImageData(0,0,t,t)}function Ha(e,t,n,o,r,s){e.addSource(t,{type:"geojson",data:{type:"FeatureCollection",features:[]}}),e.addLayer({id:n,type:"line",source:t,layout:{visibility:"none","line-cap":"round","line-join":"round","line-sort-key":["get","sort"]},paint:{"line-color":["get","color"],"line-width":Do("status"),"line-opacity":s}},r),e.addLayer({id:o,type:"symbol",source:t,layout:{visibility:"none","symbol-placement":"line","symbol-spacing":140,"symbol-sort-key":["get","sort"],"icon-image":ho,"icon-size":["interpolate",["linear"],["zoom"],12,.45,16,.8],"icon-rotation-alignment":"map","icon-allow-overlap":!0,"icon-ignore-placement":!0},paint:{"icon-color":["get","color"],"icon-opacity":s}},r)}function Va(e,t){e.hasImage(ho)||e.addImage(ho,yu(),{pixelRatio:2,sdf:!0}),Ha(e,Wa,te,tt,t,ja),Ha(e,Zt,Qt,xo,t,Ga),bu(e,t),Te(e)}function bu(e,t){e.setFilter(Qt,Na.current),e.addLayer({id:_o,type:"line",source:Zt,filter:Na.proposed,layout:{visibility:"none","line-cap":"round","line-join":"round"},paint:{"line-color":["get","color"],"line-width":Do("status"),"line-opacity":Ga,"line-dasharray":cu}},xo)}var Kt=null,_e=null,za=!1,Ee=new Set(vo),De=new Set,Po=Ro;function Oo(){return Kt?.groups??null}function ue(){return _e}function Pe(){return za}function Su(e){return`/api/route_changes?day=${e}`}function vu(e,t){return`/api/route_changes/${encodeURIComponent(e)}?day=${t}`}async function To(e,t){if(!x.includes(t))throw new Error(`no such day type: ${t}`);return Kt=await K(Su(t)),e.getSource(Wa).setData(pu(Kt)),Kt}async function Mo(e,t,n,{fly:o=!0}={}){try{_e=await K(vu(t,n))}catch{return Co(e),null}e.getSource(Zt).setData(mu(_e)),qa(e,!0);let r=gu(_e.features);return o&&r&&e.fitBounds(r,{padding:60,maxZoom:14}),_e}function Co(e){_e=null,e.getSource(Zt)?.setData({type:"FeatureCollection",features:[]}),e.getLayer(te)&&qa(e,!1)}function qa(e,t){let n=t?ru:ja;e.setPaintProperty(te,"line-opacity",n),e.setPaintProperty(tt,"icon-opacity",n)}function en(){return wo([...Ee])}function Xa(e,t){Ee.has(t)?Ee.delete(t):Ee.add(t),Te(e)}function Ao(e,t){Ee.clear();for(let n of t)Ee.add(n);Te(e)}function tn(){return $o([...De])}function Za(e,t){De.has(t)?De.delete(t):De.add(t),Te(e)}function Fo(e,t){De.clear();for(let n of t)De.add(n);Te(e)}function Oe(){return Po}function No(e,t){Po=t,e.setPaintProperty(te,"line-color",["get",bo[t].color]),e.setPaintProperty(te,"line-width",Do(t)),e.setPaintProperty(tt,"icon-color",["get",bo[t].color]),Te(e)}function Te(e){let t=Po==="status"?fu(en()):hu(tn());e.setFilter(te,t),e.setFilter(tt,t)}function Qa(e,t){za=t;for(let n of lu)e.setLayoutProperty(n,"visibility",t?"visible":"none")}var wu="A route group is PRT\u2019s own mapping of today\u2019s route numbers onto the plan\u2019s \u2014 the routes it says replace each other. It is not a corridor: a street can lose one group\u2019s buses and gain another\u2019s, and only the location, surface and street views can see that.";function ei(){return` <button class="howto" data-caveat="${ou}">method</button>`}var ti={weekday:"weekday",saturday:"Saturday",sunday:"Sunday"};function Ru(e,t){if(e.current.length===0||e.proposed.length===0)return"";let n=e.service[t].pct_trips,o=`${ti[t]} trips, today to plan`;return`<span class="rc-pct ${So(n)}" title="${u(o)}">${Vt(n)}</span>`}function So(e){return e===null||Math.round(e)===0?"flat":e>0?"up":"down"}function Lu(e,{reading:t,day:n}){let o=u(et(e,{farSideNamed:!1}));return t==="service"?`<span class="rc-map" style="color:${X[e.service[n].bucket].color}">${o}</span>`:`<span class="${e.status==="one-to-one"?"rc-map":`rc-map ${e.status}`}">${o}</span>`}function ni(e,t,n){return`
    ...
    <div class="rc-list">${t.map(r=>ni(r,r.key===n,o)).join("")}</div>`}function $u(e){return e.charAt(0).toUpperCase()+e.slice(1)}function oi(e,t,n={reading:"status",day:"weekday"}){let o=`
    <div class="place-head">
      <h2>Route changes</h2>
      <div class="muted">${e.length.toLocaleString()} route groups, ranked by weekday riders</div>
    </div>
    <p class="note">${wu}${ei()}</p>`;if(n.reading==="service")return o+ku(e,t,n);let r=a=>e.filter(i=>a.includes(i.status)),s=r(["one-to-one"]);return`${o}
    ...
    </details>`}function ku(e,t,n){let o=a=>e.filter(i=>i.service[n.day].bucket===a),r=o("none").length,s=r===0?"":`
    ...
    ${Qe.map(a=>{let i=o(a);return i.length?Wt($u(Lo[a]),i,t,n):""}).join("")}
    ${s}`}function _u(e,t){return`
    <tr><th>${e}</th>
    ...
    <table class="periods rc">
      ...
      <tbody>${x.map(n=>_u(n,e.service[n])).join("")}</tbody>
    </table>
    ${t}
    ...
    <p class="note">This is a route group, not a corridor. One group\u2019s loss
      ...
      here.${ei()}</p>`}function Eu(e,t){return`<div class="lg-row lg-static"><i style="background:${e};border-radius:2px"></i>
    <span class="lg-lab">${t}</span></div>`}function Du(e,t){return`<div class="lg-row lg-static"><i class="lg-dotted" style="border-color:${e}"></i>
    ...
    </button>`}function Jt(e,t,n,o){let r=Ua[Ia[e][0]];return si("data-route-bucket",e,r,t,n,o.includes(e))}function Pu(e,t,n){return si("data-route-service",e,X[e].color,Lo[e],t,n.includes(e))}function ai(e){return`
    <div class="seg lg-weight" role="group" aria-label="Colour the routes by">
      ${["status","service"].map(n=>`
        <button data-route-reading="${n}" aria-pressed="${e===n}"
                class="${e===n?"active":""}">${eu[n]}</button>`).join("")}
    </div>`}function Ou(e,t){let n=Object.fromEntries([...Qe,"none"].map(o=>[o,0]));for(let o of e)n[o.service[t].bucket]+=1;return n}function Tu(e,t,n){let o=Ou(e,t),r=o.gone+o.halved+o.less,s=o.more+o.doubled+o.new,a=`${e.length.toLocaleString()} route groups \xB7 ${r} fewer trips \xB7 ${o.same} about the same \xB7 ${s} more \xB7 ${xe[t]}`;return`
    <div class="lg-head"><b>${u(a)}</b></div>
    ${ai("service")}
    ${Qe.filter(i=>o[i]>0).map(i=>Pu(i,o[i],n)).join("")}
    <div class="lg-foot">Each group\u2019s trips today \u2192 plan on ${u(xe[t])}, in the
      ...
      ${Eu(we,"today's alignment")}
      ${Du(qe,"proposed alignment")}
      <div class="lg-foot">The rest of the network is dimmed. Click a line to
        ...
        nothing is measured off their length.</div>`;if(!e)return'<div class="lg-head"><b>Route changes</b></div>';if(r==="service")return Tu(e,t,o);let a=iu(e),i=a.split+a.merged,c=`${e.length.toLocaleString()} route groups \xB7 ${a.discontinued} discontinued \xB7 ${a.new} new \xB7 ${i} split or merged \xB7 ${xe[t]}`;return`
    ...
    <div class="lg-foot">A route group is PRT\u2019s own mapping of today\u2019s
      ...
      click a line to select its group.</div>`}function li(e,{selected:t,reading:n="status"}){let o=u(e.name?`${e.route} ${e.name}`:e.route),r=u(au[e.side]),s=u(ko[e.status]),a=n==="service"?` \xB7 ${u(Lo[e.bucket])}${e.pct===null?"":` (${Vt(e.pct)} trips)`}`:"";return t?`${o} \xB7 <b>${r}</b> \xB7 ${s}${a}`:`<b>${o}</b> \xB7 ${r} \xB7 ${s}${a}`}var Ho=" \xB7 ",Bo={dots:"Stop-by-stop",surface:"Surface",both:"Stop-by-stop + surface",corridors:"Streets",oneseat:"One-seat ride",journey:"Travel time",places:"Places",routes:"Route changes"},ci=Object.keys(Bo);function ui(e){return Bo[e]??e}var Mu={weekday:"a weekday",saturday:"a Saturday",sunday:"a Sunday"},Cu=["oneseat","journey"],Au=["dots","both"],Fu={current:"routes today",proposed:"routes proposed"};function Nu(e){return e!=="journey"&&e!=="routes"}function Hu(e){let t=[Bo[e.view]??e.view];return e.view==="places"?t[0]:(Cu.includes(e.view)&&(t[0]+=` to ${e.destination}`),t.push(e.view==="oneseat"&&!e.oneSeatRestricted?"any day":Mu[e.day]),Nu(e.view)&&t.push(`${e.radius} m walk`),e.stopRoutes!=="off"&&Au.includes(e.view)&&t.push(Fu[e.stopRoutes]),t.join(Ho))}function di(e){let[t,...n]=Hu(e).split(Ho);return`<b>${u(t)}</b>${n.map(o=>Ho+u(o)).join("")}`}var h={view:"view",day:"day",radius:"radius",oneSeatDay:"oneseatday",dest:"dest",weight:"weight",surfaceUnit:"surfaceunit",at:"at",camera:"map",place:"place",placeFill:"placefill",selection:"sel",stopRoutes:"stoproutes",route:"route",routeHidden:"routehide",routeReading:"routecolor",serviceHidden:"servicehide"},Bu=/^[cp]:[\w.:-]{1,32}$/,nn={any:"any",selected:"selected"},Iu="pin",pi=5,gi="none",on=",";function fi(e){try{return e.self!==e.top}catch{return!0}}function hi(e){let t=new URLSearchParams;return t.set(h.view,e.view),t.set(h.day,e.day),t.set(h.radius,String(e.radius)),t.set(h.oneSeatDay,e.oneSeatRestricted?nn.selected:nn.any),t.set(h.dest,"key"in e.dest?e.dest.key:Io(e.dest)),e.weight==="riders"&&t.set(h.weight,e.weight),e.surfaceUnit==="people"&&t.set(h.surfaceUnit,e.surfaceUnit),e.at&&t.set(h.at,Io(e.at)),e.camera&&t.set(h.camera,`${Io(e.camera)},${e.camera.zoom.toFixed(2)}`),e.place&&t.set(h.place,e.place),e.placeFill!==ke&&t.set(h.placeFill,e.placeFill),e.selection.length&&t.set(h.selection,e.selection.join(",")),t.set(h.stopRoutes,e.stopRoutes??Ft),e.route&&t.set(h.route,e.route),e.routeHidden&&!Uu(e.routeHidden,vo)&&t.set(h.routeHidden,e.routeHidden.length?e.routeHidden.join(on):gi),e.routeReading&&e.routeReading!==Ro&&t.set(h.routeReading,e.routeReading),e.serviceHidden?.length&&t.set(h.serviceHidden,e.serviceHidden.join(on)),`?${t}`}function yi(e){let t=new URLSearchParams(e),n={},o=t.get(h.view);o&&ci.includes(o)&&(n.view=o);let r=t.get(h.day);r&&x.includes(r)&&(n.day=r);let s=Number(t.get(h.radius));t.has(h.radius)&&Number.isFinite(s)&&s>0&&(n.radius=s),t.get(h.weight)==="riders"?n.weight="riders":t.get(h.weight)==="locations"&&(n.weight="locations"),t.get(h.surfaceUnit)==="people"?n.surfaceUnit="people":t.get(h.surfaceUnit)==="area"&&(n.surfaceUnit="area");let a=t.get(h.oneSeatDay);a===nn.selected?n.oneSeatRestricted=!0:a===nn.any&&(n.oneSeatRestricted=!1);let i=t.get(h.dest);if(i&&i!==Iu){let R=mi(i);R?n.dest=R:i.includes(",")||(n.dest={key:i})}let c=mi(t.get(h.at));c&&(n.at=c);let m=ju(t.get(h.camera));m&&(n.camera=m);let p=t.get(h.place);p&&(n.place=p);let b=t.get(h.selection);b!==null&&(n.selection=b.split(",").filter(R=>Bu.test(R)));let L=t.get(h.placeFill);(L==="lost"||L==="gained"||L==="service")&&(n.placeFill=L);let v=t.get(h.stopRoutes);(v==="off"||v==="current"||v==="proposed")&&(n.stopRoutes=v);let k=t.get(h.route);k&&Ja(k)&&(n.route=k);let f=t.get(h.routeHidden);if(f===gi)n.routeHidden=[];else if(f){let R=wo(f.split(on).filter(zt));R.length&&(n.routeHidden=R)}let T=t.get(h.routeReading);T&&qt(T)&&(n.routeReading=T);let H=t.get(h.serviceHidden);if(H){let R=$o(H.split(on).filter(Xt));R.length&&(n.serviceHidden=R)}return n}function Uu(e,t){return e.length===t.length&&e.every((n,o)=>n===t[o])}function Io(e){return`${e.lat.toFixed(pi)},${e.lon.toFixed(pi)}`}function mi(e){let t=bi(e,2);return t?{lat:t[0],lon:t[1]}:null}function ju(e){let t=bi(e,3);return t?{lat:t[0],lon:t[1],zoom:t[2]}:null}function bi(e,t){if(!e)return null;let n=e.split(",").map(Number);return n.length!==t||!n.every(Number.isFinite)?null:n}var Uo="embed";var Gu=["1","true","yes"];function Si(e){let t=new URLSearchParams(e).get(Uo);return t!==null&&Gu.includes(t.toLowerCase())}function vi(e){let t=new URLSearchParams(e);return t.set(Uo,"1"),`?${t}`}function wi(e){let t=new URLSearchParams(e);t.delete(Uo);let n=String(t);return n?`?${n}`:""}function Ri(e){return(e?`Full answer for ${e}`:"Open the full map")+" \u2197"}var ne=["peek","half","full"],Ju=192,Ku=.3,Wu=.55,Yu=.9,Vu=.6,zu=.45;function rn(e,t){return e==="peek"?Math.min(Ju,t*Ku):e==="half"?t*Wu:t*Yu}function qu(e,t,n=0){let o=ne.map(s=>Math.abs(rn(s,t)-e)),r=o.indexOf(Math.min(...o));return Math.abs(n)>Vu&&(r=Math.max(0,Math.min(ne.length-1,r+(n>0?1:-1)))),ne[r]}function Li(e){return ne[(ne.indexOf(e)+1)%ne.length]}function Xu(e,t){return Math.min(e,t*zu)}function Me(){return getComputedStyle(document.documentElement).getPropertyValue("--compact").trim()==="1"}function jo(e){let t=null,n=()=>{let o=Me();o!==t&&(t=o,e(o))};return window.addEventListener("resize",n),n(),n}var Zu=8,Qu=400;function $i(e){let t=d("side"),n=d("sheet-handle"),o="peek",r=!1,s=0,a=0,i=0,c={y:0,t:0};function m(){return window.innerHeight}function p(f){t.style.height=`${f}px`,e.onMove(f,Xu(f,m()))}function b(f){o=f,t.dataset.snap=f,p(rn(f,m()))}n.addEventListener("pointerdown",f=>{Me()&&(r=!0,s=f.clientY,a=t.getBoundingClientRect().height,i=f.timeStamp,c={y:f.clientY,t:f.timeStamp},t.classList.add("dragging"),n.setPointerCapture(f.pointerId))}),n.addEventListener("pointermove",f=>{if(!r)return;let T=a+(s-f.clientY),H=rn("peek",m()),R=rn("full",m());p(Math.max(H,Math.min(R,T))),c={y:f.clientY,t:f.timeStamp}});function L(f){if(!r)return;if(r=!1,t.classList.remove("dragging"),!(Math.abs(f.clientY-s)>Zu)&&f.timeStamp-i<Qu){b(Li(o));return}let H=f.timeStamp-c.t,R=H>0?(c.y-f.clientY)/H:0;b(qu(t.getBoundingClientRect().height,m(),R))}n.addEventListener("pointerup",L),n.addEventListener("pointercancel",L),n.addEventListener("keydown",f=>{f.key!=="Enter"&&f.key!==" "||(f.preventDefault(),Me()&&b(Li(o)))});let v=jo(e.onLayoutChange);function k(){if(v(),!Me()){t.style.height="",t.removeAttribute("data-snap"),e.onMove(0,0);return}b(o)}return window.addEventListener("resize",k),k(),{at:()=>Me()?o:"full",atLeast(f){Me()&&ne.indexOf(f)>ne.indexOf(o)&&b(f)}}}var ed=["llvmpipe","swiftshader","softpipe","basic render","software"];function Go(e){if(!e)return!1;let t=e.toLowerCase();return ed.some(n=>t.includes(n))}function _i(e){let t=Go(e.renderer)?1:2;return Math.min(e.dpr||1,t)}function xi(e){return Go(e.renderer)?0:td}var td=300,nd="https://tiles.openfreemap.org/styles/positron",od=["https://tile.openstreetmap.org/{z}/{x}/{y}.png"],ki=[],rd=19,sd='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',ad=!1;function Ei(e){return!ad||!Go(e.renderer)?nd:id()}function id(){let e=o=>({type:"raster",tileSize:256,attribution:sd,tiles:o,maxzoom:rd}),t={basemap:e(od)},n=[{id:"basemap",type:"raster",source:"basemap"}];return ki.length&&(t["basemap-labels"]=e(ki),n.push({id:"basemap-labels",type:"raster",source:"basemap-labels"})),{version:8,sources:t,layers:n}}function Di(e=window){let t=e.devicePixelRatio||1;try{let n=e.document.createElement("canvas").getContext("webgl2")??e.document.createElement("canvas").getContext("webgl");if(!n)return{renderer:null,dpr:t};let o=n.getExtension("WEBGL_debug_renderer_info"),r=o?n.getParameter(o.UNMASKED_RENDERER_WEBGL):n.getParameter(n.RENDERER);return{renderer:typeof r=="string"?r:null,dpr:t}}catch{return{renderer:null,dpr:t}}}function ld(e){return`${e.layer?.id}:${e.id??JSON.stringify(e.geometry?.coordinates)}`}function Pi(e,t,n){let o=new Map(n.map(c=>[c.layer,c])),r=null,s="",a=c=>{s!==c&&(s=c,e.getCanvas().style.cursor=c)},i=()=>{r=null,a(""),t.remove()};return e.on("mousemove",c=>{let m=n.map(T=>T.layer).filter(T=>e.getLayer(T)&&e.getLayoutProperty(T,"visibility")!=="none");if(!m.length){i();return}let[p,...b]=e.queryRenderedFeatures(c.point,{layers:m});if(!p){i();return}a("pointer");let L=ld(p);if(L===r)return;let v=o.get(p.layer?.id),k=v?v.html(p,b):null;if(k==null){r=null,t.remove();return}r=L;let f=v.anchor?v.anchor(p,c):c.lngLat;t.setLngLat(f).setHTML(k).addTo(e)}),e.on("mouseout",i),i}function cd(e){let t=e.find(n=>n.active)??e[0];return t?{label:t.label,disabled:t.disabled,armed:t.armed}:{label:"",disabled:!0,armed:!1}}function ud(e,t){return t.kind!=="trigger"||e===t.group?null:t.group}var dd="seg-current",Oi="dd",pd="open",Ti="armed";function md(e){let t=Array.from(e.querySelectorAll("button")).map(n=>({label:n.textContent??"",active:n.classList.contains("active"),disabled:n.disabled,armed:n.classList.contains(Ti)}));return cd(t)}function Mi(e=document){let t=new Map,n=null,o=s=>{n=s;for(let[a,i]of t){let c=a===n;i.group.classList.toggle(pd,c),i.trigger.setAttribute("aria-expanded",String(c))}},r=s=>o(ud(n,s));e.querySelectorAll(".controls").forEach((s,a)=>{let i=s.querySelector(".seg");if(!i)return;let c=s.id||`controls-${a}`,m=s.querySelector(".lbl")?.textContent??"",p=document.createElement("button");p.type="button",p.className=dd,p.setAttribute("aria-haspopup","true"),p.setAttribute("aria-expanded","false");let b=document.createElement("div");b.className=Oi,i.replaceWith(b),b.append(p,i);let L=()=>{let v=md(i);p.textContent=v.label,p.disabled=v.disabled,p.classList.toggle(Ti,v.armed),p.setAttribute("aria-label",m?`${m}: ${v.label}`:v.label)};L(),new MutationObserver(L).observe(i,{subtree:!0,childList:!0,characterData:!0,attributes:!0,attributeFilter:["class","disabled"]}),p.addEventListener("click",()=>{r({kind:"trigger",group:c}),n===c&&i.querySelector("button.active")?.focus()}),i.addEventListener("click",v=>{if(!v.target.closest("button"))return;let k=n===c;r({kind:"pick"}),k&&p.focus()}),t.set(c,{group:s,trigger:p,seg:i})}),document.addEventListener("click",s=>{if(n===null)return;s.target.closest(`.${Oi}`)||r({kind:"outside"})}),document.addEventListener("keydown",s=>{if(s.key!=="Escape"||n===null)return;let a=t.get(n);r({kind:"escape"}),a&&a.seg.contains(document.activeElement)&&a.trigger.focus()})}var gd=[-79.9959,40.4406],fd=12,hd="#e2574c",sn=5,O={radius:"data-radius",day:"data-day",oneSeatDay:"data-oneseat-day",view:"data-view",dest:"data-dest",placeFill:"data-place-fill",stopRoutes:"data-stop-routes"},ot=yi(location.search),st=Si(location.search);st&&d("app").classList.add("embed");var yd={at:()=>"full",atLeast(){}},Hi=null,F=400,nt=null,S=null,re=null,me=0,_={key:"downtown"},de=null,Bi=!1,Fe=!1,gn="locations",Ne="area",I=Ft,Jo=0;function ln(){return I==="off"?"current":I}var Ii="count",pn=null,G=ke,ge=null,J=!1,g="dots",Vo,qo=[],Ci=()=>{},Ko=Di(),l=new maplibregl.Map({container:"map",style:Ei(Ko),pixelRatio:_i(Ko),fadeDuration:xi(Ko),renderWorldCopies:!1,center:ot.camera?[ot.camera.lon,ot.camera.lat]:gd,zoom:ot.camera?.zoom??fd,cooperativeGestures:fi(window),attributionControl:{compact:!0}});l.addControl(new maplibregl.NavigationControl,"top-right");l.on("load",()=>{ar(l),is(l),ys(l,Ye),Ls(l,Ye),Ps(l,"walk-fill"),Zs(l),pa(l,Tt),xa(l,Ye),Va(l,Ye),D(),l.on("click",t=>{if(J)return;if(Bi){rt({lat:t.lngLat.lat,lon:t.lngLat.lng});return}if(g==="places"){let s=l.queryRenderedFeatures(t.point,{layers:[ce]})[0];s&&cn(s.properties.key);return}if(g==="routes"){let{x:s,y:a}=t.point,i=[[s-sn,a-sn],[s+sn,a+sn]],c=l.queryRenderedFeatures(i,{layers:Eo})[0];c?(Vo.atLeast("half"),zo(c.properties.key)):Ai();return}let n=[...yt,"oneseat-dots"].filter(s=>l.getLayoutProperty(s,"visibility")!=="none"),o=l.queryRenderedFeatures(t.point,{layers:n})[0],r=o?o.geometry.coordinates:[t.lngLat.lng,t.lngLat.lat];er(r[1],r[0])});let e=new maplibregl.Popup({closeButton:!1,offset:8});Ci=Pi(l,e,[...ir(t=>{let n=bt(),o=t.find(r=>yt.includes(r.layer?.id));return n&&o?Un(o.properties,w(),n.buckets,{pole:!1}):null}),...yt.map(t=>({layer:t,html:n=>{let o=bt();return o?Un(n.properties,w(),o.buckets):null},anchor:n=>n.geometry.coordinates})),{layer:"oneseat-dots",html:t=>{let n=ve();return n?As(t.properties,n):null},anchor:t=>t.geometry.coordinates},{layer:"stoproutes-lines",html:t=>ga(t.properties)},...Eo.map(t=>({layer:t,html:n=>li(n.properties,{selected:ue()!==null,reading:Oe()})})),{layer:ce,html:t=>Aa(t.properties,G,w())}]),Cd(),l.on("moveend",()=>{let t=l.getCenter();Hi={lat:t.lat,lon:t.lng,zoom:l.getZoom()},y(),E()}),pe(O.radius,t=>{F=Number(t.dataset.radius),Hn(l,F,w()).then(y),wt()&&Kn(l,F,w()).then(y),Rt()&&Vn(F).then(y),ve()&&un(),S&&Ce(S.lat,S.lon)}),pe(O.day,t=>{let n=t.dataset.day;Dr(n),g!=="journey"&&D(),Bn(l,n),mn(),Wn(l,n),g==="journey"&&S&&Xo(S.lat,S.lon),kt()&&$s(l,n).then(y),Fe&&ve()&&(un(),S&&Ce(S.lat,S.lon)),Ze()&&G==="service"&&jt(l,G,n),Pe()&&Ed(),y()}),pe(O.oneSeatDay,t=>{Fe=t.dataset.oneseatDay==="selected",Yo(),un(),S&&Ce(S.lat,S.lon)}),pe(O.view,t=>{let n=g;g=t.dataset.view,Ci(),Wr(l,g==="dots"||g==="both"),Ld(g==="surface"||g==="both"),kd(g==="corridors"),Od(g==="oneseat"),Pd(g==="journey",n==="journey"),_d(g==="places"),xd(g==="routes"),g!=="journey"&&n!=="journey"&&(g==="oneseat"||n==="oneseat")&&D({scrollToTop:!0}),Dd(Ln(g)),Ji();let o=g==="oneseat"||g==="journey";d("dest-controls").classList.toggle("hidden",!o),d("oneseat-day-controls").classList.toggle("hidden",g!=="oneseat"),d("place-fill-controls").classList.toggle("hidden",g!=="places"),Wi(),z()||Fi(!1),Ae(),Yo(),o||dn(!1),ji()}),pe(O.dest,t=>{let n=t.dataset.dest;if(n==="pin"){dn(!0);return}dn(!1),rt({key:n})}),pe(O.placeFill,t=>{G=t.dataset.placeFill,Ze()&&jt(l,G,w()),D(),y(),Yo()}),pe(O.stopRoutes,t=>{let n=t.dataset.stopRoutes,o=I!=="off"&&Nt()!==null;I=n,D(),o&&n!=="off"?(Le(l,Nt(),n),N&&Qo(N.radius)):mn()}),d("legend").addEventListener("click",t=>{let n=t.target.closest("[data-weight]");if(n){gn=n.dataset.weight,y(),E();return}let o=t.target.closest("[data-surface-unit]");if(o){Ne=o.dataset.surfaceUnit,$d(Ne),E();return}let r=t.target.closest("[data-route-bucket]");if(r&&zt(r.dataset.routeBucket)){Xa(l,r.dataset.routeBucket),y(),E();return}let s=t.target.closest("[data-route-service]");if(s&&Xt(s.dataset.routeService)){Za(l,s.dataset.routeService),y(),E();return}let a=t.target.closest("[data-route-reading]");if(a&&qt(a.dataset.routeReading)){No(l,a.dataset.routeReading),y(),Pe()&&D(),E();return}let i=t.target.closest("[data-bucket]");i&&(ls(l,i.dataset.bucket,w()),y())}),d("legend-reset").addEventListener("click",()=>{if(Pe()){Oe()==="service"?Fo(l,[]):Ao(l,[]),y(),E();return}cs(l,w()),y()}),d("legend-select").addEventListener("click",()=>Fi(!J)),d("legend-clear").addEventListener("click",()=>{Fn(l),Ae(),y(),E()}),d("legend-collapse").addEventListener("click",()=>{Wo(!d("legend-box").classList.contains("collapsed"))}),d("panel").addEventListener("click",t=>{let n=t.target.closest("[data-goto-dest]");n&&rt({key:n.dataset.gotoDest});let o=t.target.closest("[data-caveat]");o&&Nd(o.dataset.caveat);let r=t.target.closest("[data-select-place]");r&&cn(r.dataset.selectPlace);let s=t.target.closest("[data-select-route]");if(s){let c=s.dataset.selectRoute;c?zo(c):Ai()}let a=t.target.closest("[data-sort-places]");a&&(Ii=a.dataset.sortPlaces,D());let i=t.target.closest("[data-goto-place]");i&&(g!=="places"&&oe(O.view,"places"),cn(i.dataset.gotoPlace))}),d("side-toggle").addEventListener("click",wd),st&&jo(Wo),Vo=st?yd:$i({onMove(t,n){document.documentElement.style.setProperty("--sheet-h",`${t}px`),l.setPadding({top:0,right:0,bottom:n,left:0})},onLayoutChange:Wo}),Sd(),Mi(),hn(),Ae(),fn(),bd(ot),Hn(l,F,w()).then(y),Fd(),Ad()});function pe(e,t){let n=`[${e}]`;document.querySelectorAll(n).forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(n).forEach(r=>r.classList.toggle("active",r===o)),t(o),hn(),E()})})}function oe(e,t){let n=document.querySelector(`[${e}="${t}"]`);return n?.click(),n!==null}function bd(e){e.radius!==void 0&&oe(O.radius,String(e.radius)),e.day&&oe(O.day,e.day),e.oneSeatRestricted!==void 0&&oe(O.oneSeatDay,e.oneSeatRestricted?"selected":"any"),e.weight&&(gn=e.weight),e.surfaceUnit&&(Ne=e.surfaceUnit),e.placeFill&&oe(O.placeFill,e.placeFill),e.routeHidden&&Ao(l,e.routeHidden),e.serviceHidden&&Fo(l,e.serviceHidden),e.routeReading&&No(l,e.routeReading),e.dest&&("key"in e.dest?oe(O.dest,e.dest.key):rt(e.dest)),e.selection&&Qr(l,e.selection),e.stopRoutes&&oe(O.stopRoutes,e.stopRoutes),e.view&&oe(O.view,e.view),e.at&&er(e.at.lat,e.at.lon),e.place&&cn(e.place),e.route&&zo(e.route,{fly:!e.camera})}function E(){let e={view:g,day:w(),radius:F,oneSeatRestricted:Fe,weight:gn,surfaceUnit:Ne,dest:_,at:S,camera:Hi,place:pn,placeFill:G,selection:qr(),stopRoutes:I,route:ge,routeHidden:en(),routeReading:Oe(),serviceHidden:tn()},t=hi(e);history.replaceState(null,"",(st?vi(t):t)+location.hash),fn(t)}function fn(e=wi(location.search)){if(!st)return;let t=d("embed-link");t.href=`${location.pathname}${e}${location.hash}`;let n=g==="routes"?ue()?et(ue()):null:S?re?Je(re):"this point":null;t.querySelector(".el-action").textContent=Ri(n)}function hn(){d("statebar").innerHTML=di({view:g,day:w(),radius:F,oneSeatRestricted:Fe,destination:at(),stopRoutes:I}),vd()}function Wo(e){d("legend-box").classList.toggle("collapsed",e);let t=d("legend-collapse");t.textContent=e?"+":"\u2013",t.title=e?"Show the key":"Collapse the key",t.setAttribute("aria-expanded",String(!e))}function Sd(){let e=t=>{d("app").classList.toggle("controls-open",t),d("controls-toggle").setAttribute("aria-expanded",String(t))};d("controls-toggle").addEventListener("click",()=>{e(!d("app").classList.contains("controls-open"))}),d("controls-scrim").addEventListener("click",()=>e(!1)),document.addEventListener("keydown",t=>{t.key==="Escape"&&e(!1)})}function vd(){d("controls-toggle").firstChild?.remove(),d("controls-toggle").prepend(document.createTextNode(ui(g)))}function wd(){let e=d("app").classList.toggle("side-collapsed"),t=d("side-toggle");t.textContent=e?"\u203A":"\u2039",t.title=e?"Show the panel":"Hide the panel",t.setAttribute("aria-expanded",String(!e)),l.resize()}function y(){Rd()}function Rd(){if(d("legend-reset").classList.toggle("hidden",qn()||eo()||so()||Ze()||!(z()||Pe())),so()){d("legend").innerHTML=oa(Mt());return}if(Pe()){d("legend").innerHTML=ii({groups:Oo(),day:w(),hidden:en(),serviceHidden:tn(),reading:Oe(),selected:ue()});return}if(Ze()){d("legend").innerHTML=Ca({selected:La(),fill:G,day:w(),boundaries:go(),unchanged:$a()});return}if(qn()){let n=kt();n&&Bs(d("legend"),n);return}if(eo()){let n=ve();if(!n)return;let o=l.getBounds();Is(d("legend"),n,{west:o.getWest(),south:o.getSouth(),east:o.getEast(),north:o.getNorth()});return}let e=bt();if(!e)return;let t=l.getBounds();js(d("legend"),{layer:e,day:w(),bounds:{west:t.getWest(),south:t.getSouth(),east:t.getEast(),north:t.getNorth()},weight:gn,dots:z(),surface:Jn()?wt():null,unit:Ne,population:Rt(),selection:zr()})}async function Ld(e){if(e&&!wt()){d("legend").classList.add("loading");try{await Kn(l,F,w())}finally{d("legend").classList.remove("loading")}}bs(l,e),e&&Ne==="people"&&await Ui(),y()}async function Ui(){if(!Rt()){d("legend").classList.add("loading");try{await Vn(F)}finally{d("legend").classList.remove("loading")}}}async function $d(e){e==="people"&&Jn()&&await Ui(),y()}async function kd(e){if(e&&!kt()){d("legend").classList.add("loading");try{await Xn(l,w())}finally{d("legend").classList.remove("loading")}}ks(l,e),y()}async function _d(e){if(e&&(!mo()||!go())){d("legend").classList.add("loading");try{await Promise.all([Ea(),Da(l)])}finally{d("legend").classList.remove("loading")}}Oa(l,e),e&&jt(l,G,w()),e&&D(),y()}async function cn(e){pn=await He(()=>Pa(l,e))?e:null,g==="places"&&(D(),pn&&document.querySelector(`[data-select-place="${CSS.escape(e)}"]`)?.scrollIntoView({block:"nearest"})),y(),E()}async function xd(e){e&&await He(()=>To(l,w())),Qa(l,e),e&&D({scrollToTop:!0}),y()}async function zo(e,{fly:t=!0}={}){ge=await He(()=>Mo(l,e,w(),{fly:t}))?e:null,g==="routes"&&D({scrollToTop:!0}),y(),E()}function Ai(){!ge&&!ue()||(Co(l),ge=null,g==="routes"&&D({scrollToTop:!0}),y(),E())}async function Ed(){await He(async()=>{await To(l,w()),ge&&await Mo(l,ge,w(),{fly:!1})}),g==="routes"&&D(),y()}function Dd(e){document.querySelectorAll("[data-radius]").forEach(t=>{t.disabled=!e})}function D({scrollToTop:e=!1}={}){if(e&&(d("panel").scrollTop=0),fn(),g==="places"){d("panel").innerHTML=Ta(mo()??[],Ii,pn,G);return}if(g==="routes"){let t=ue();d("panel").innerHTML=t?ri(t):oi(Oo()??[],ge,{reading:Oe(),day:w()});return}if(!re){g==="oneseat"?d("panel").innerHTML=jr(at()):Pr(d("panel"));return}if(g==="oneseat"){let t=Ur(re,_,w());if(t){d("panel").innerHTML=t;return}}Ir(re,{withKerb:z(),routes:I})}function Pd(e,t=!1){if(Qs(l,e),y(),!e){t&&(S?Ce(S.lat,S.lon):D());return}Mt()&&S?d("panel").innerHTML=io(Mt(),at()):d("panel").innerHTML=na(at())}async function Xo(e,t){let n=++me;S={lat:e,lon:t},E(),Ki(e,t);let o=Gi(),r=u(at());if(!o){d("panel").innerHTML=`<div class="empty"><h2>No destination yet</h2>
    ...
    <p class="muted">Routing both networks from this point to
       ...
       <p class="muted">${s.message}</p></div>`}}function Yo(){d("day-controls").classList.toggle("hidden",!Ms(g,Fe,G))}function Zo(){return Ts(Fe,w())}async function Od(e){e&&!ve()&&await He(()=>to(l,F,_,Zo())),Cs(l,e),y()}async function un(){await He(()=>to(l,F,_,Zo())),y()}async function He(e){d("legend").classList.add("loading");try{return await e()}finally{d("legend").classList.remove("loading")}}function rt(e){if(_=e,dn(!1),Td(),ji(),hn(),E(),g==="journey"){S&&Xo(S.lat,S.lon),y();return}S?Ce(S.lat,S.lon):D({scrollToTop:!0}),un()}function ji(){let e=Gi();if(!(e!==null&&(g==="journey"||g==="oneseat"&&"lat"in _))){de?.remove(),de=null;return}de?de.setLngLat([e.lon,e.lat]).addTo(l):(de=new maplibregl.Marker({color:Qn,draggable:!0}).setLngLat([e.lon,e.lat]).addTo(l),de.on("dragend",()=>{let n=de.getLngLat();rt({lat:n.lat,lon:n.lng})}))}function Td(){let e=Os(_);document.querySelectorAll("[data-dest]").forEach(t=>{t.classList.toggle("active",t.dataset.dest===e)})}function Gi(){if("lat"in _)return{lat:_.lat,lon:_.lon};let e=_.key,t=qo.find(n=>n.key===e);return t?{lat:t.lat,lon:t.lon}:null}function at(){if("lat"in _)return`${_.lat.toFixed(4)}, ${_.lon.toFixed(4)}`;let e=_.key;return qo.find(t=>t.key===e)?.name??e}function dn(e){Bi=e,l.getCanvas().style.cursor=e?"crosshair":"",document.querySelectorAll('[data-dest="pin"]').forEach(t=>{t.classList.toggle("armed",e),t.textContent=e?"click the map\u2026":"Pick a point"})}async function Ce(e,t){let n=++me;S={lat:e,lon:t},E(),d("panel").classList.add("loading"),Ki(e,t),$n(l),Le(l,null,ln()),d("pin-key").classList.add("hidden");try{let o="lat"in _?`&dest_lat=${_.lat.toFixed(6)}&dest_lon=${_.lon.toFixed(6)}`:"",r=await P(`/api/place?lat=${e.toFixed(6)}&lon=${t.toFixed(6)}&radius=${F}${o}&oneseat_day=${Zo()}`);if(n!==me)return;N={lat:e,lon:t,radius:F,now:r.current.stops,proposed:r.proposed.stops},re=r,Wi(),Ji(),D({scrollToTop:!0})}catch(o){if(n!==me)return;d("panel").innerHTML=`<div class="empty"><h2>No answer for that point</h2>
       <p class="muted">${o.message}</p></div>`}finally{n===me&&d("panel").classList.remove("loading")}}var N=null;function Ji(){if(!N||!Ln(g)){$n(l),d("pin-key").classList.add("hidden"),mn();return}lr(l,N.lat,N.lon,N.radius,N.now,N.proposed),Qo(N.radius),mn()}function mn(){let e=++Jo,t=()=>{N&&Qo(N.radius)};I!=="off"&&z()&&S&&re?.kerb?P(ma(S,w())).then(n=>{e===Jo&&(Le(l,n,ln()),Ht(l,!0),ha(l),t())}).catch(()=>{e===Jo&&(Le(l,null,ln()),Ht(l,!1),t())}):(Le(l,null,ln()),Ht(l,!1),t())}function Qo(e){let t=I!=="off"&&ua()&&da(Nt(),I)?I:!1;d("pin-key").innerHTML=Us(e,{routes:t}),d("pin-key").classList.remove("hidden")}function Ki(e,t){nt?nt.setLngLat([t,e]):(nt=new maplibregl.Marker({color:hd,draggable:!0}).setLngLat([t,e]).addTo(l),nt.on("dragend",()=>{let n=nt.getLngLat();er(n.lat,n.lng)}))}var an=14;function z(){return g==="dots"||g==="both"}function Fi(e){J=e&&z(),J?l.dragPan.disable():l.dragPan.enable(),l.getCanvas().style.cursor=J?"none":"",J||Yi(),Ae()}function Wi(){let e=z()&&!!re?.kerb;d("stop-routes-controls").classList.toggle("hidden",!e)}function Ae(){let e=d("legend-select");e.classList.toggle("hidden",!z()),e.setAttribute("aria-pressed",String(J)),e.textContent=J?"Selecting":"Select stops",d("legend-clear").classList.toggle("hidden",!z()||!Xr())}function Md(e,t){let n=d("brush");n.style.left=`${e}px`,n.style.top=`${t}px`,n.hidden=!J}function Ni(e){d("brush").classList.toggle("painting",e)}function Yi(){d("brush").hidden=!0}function Cd(){let e=d("brush");e.style.width=`${an*2}px`,e.style.height=`${an*2}px`;let t=!1,n=!1,o=!1,r=()=>{o||(o=!0,requestAnimationFrame(()=>{o=!1,Ae(),y()}))},s=()=>{J&&(t=!0,n=!1,Ni(!0))},a=c=>{if(Md(c.point.x,c.point.y),!t)return;n=!0,An(l,Nn(l,c.point.x,c.point.y,an))&&r()},i=c=>{if(Ni(!1),!!t){if(t=!1,!n){let[m]=Nn(l,c.point.x,c.point.y,an);m&&Zr(l,m)}Ae(),y(),E()}};l.on("mousedown",s),l.on("mousemove",a),l.on("mouseup",i),l.getCanvas().addEventListener("mouseleave",Yi),l.on("touchstart",s),l.on("touchmove",a),l.on("touchend",i)}function er(e,t){if(Vo.atLeast("half"),g==="journey"){Xo(e,t);return}g!=="places"&&g!=="routes"&&Ce(e,t)}async function Ad(){try{qo=await P("/api/destinations"),hn()}catch{}}async function Fd(){try{let e=await P("/api/meta"),t=`today: ${e.feeds.current_feed_version||"current GTFS"} \xB7 proposed: ${e.feeds.proposed_feed_version||"proposed-network feed"}`;d("feedline").textContent=t,d("feedline-methods").textContent=t,d("caveats").innerHTML=e.caveats.map(n=>`<li id="caveat-${n.id}">${n.text}</li>`).join("")}catch{}}function Nd(e){d("methods").classList.add("open");let t=document.getElementById(`caveat-${e}`);t&&(t.scrollIntoView({block:"center"}),t.classList.remove("asked"),t.offsetWidth,t.classList.add("asked"))}d("methods-open").addEventListener("click",()=>d("methods").classList.add("open"));d("methods-close").addEventListener("click",()=>d("methods").classList.remove("open"));})();
