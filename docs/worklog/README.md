...
| [Nothing on the map can be asked about one time of day](nothing-on-the-map-can-be-asked-about-one-time-of-day.md) | open, scoped, not started — five views ranked; dots and surface can show a published per-period figure with no new analysis; raised by Max for PPT readers |
