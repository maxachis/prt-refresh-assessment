...
| [The dot hover reported a district, not a stop](the-dot-hover-reported-a-district-not-a-stop.md) | fixed, awaiting close — a downtown dot said 1,591 buses a weekday; it says its own pole's 167 now, and the colour is scoped "nearby"; raised by Max |
