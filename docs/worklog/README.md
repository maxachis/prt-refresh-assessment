...
| [A pole the plan drops quietly has no mark of its own](a-pole-the-plan-drops-quietly-has-no-mark.md) | open, decision owed — 434 poles are retired without a cross because the plan serves a stop within 150 m; 381 of them read as a dot whose neighbours have a ring; raised by Max |
