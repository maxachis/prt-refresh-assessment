...
| [The dot key lost its caveats](the-dot-key-lost-its-caveats.md) | open — the three footnotes under the Stop-by-stop key came out 2026-09-10 on Max's instruction; the infill misreading PPT and PRT both made is unguarded on the map again |
