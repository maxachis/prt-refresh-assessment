...
| [A link carrying a day opens with no dots](a-link-carrying-a-day-opens-with-no-dots.md) | open, not fixed — every link the app writes carries `day=`, and that is the one control whose press claims a fetch it never makes |
