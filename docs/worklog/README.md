...
| [The dot key lost its caveats](the-dot-key-lost-its-caveats.md) | fixed, awaiting close — the three footnotes came out 2026-09-10; the infill one was replaced by a layer of the plan's own stops, the other two by nothing |
