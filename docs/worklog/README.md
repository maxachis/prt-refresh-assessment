...
| [The marks around the pin borrow the dot palette](the-pin-marks-borrow-the-dot-palette.md) | open, half fixed — "stop today" moved to ink 2026-09-09 after Max read it as "new service"; "stop proposed" is still ΔE 16.7 from "halved or worse" |
