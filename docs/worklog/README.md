...
| [Address search needs a geocoder, and the access log must not see the query](address-search-needs-a-geocoder-and-the-log-must-not-see-the-query.md) | open, one decision owed — source found (county address points on WPRDC), licence unstated; the what-to-tell-PPT half closed 2026-09-17 |
