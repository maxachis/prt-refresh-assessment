...
**356 locations, carrying 3,449 weekday boardings.** Their weekday trip count
...
|---:|---|---|---|---|---:|
| 141.1 | WALMART + SHELTER | North Versailles | 55, 59 | 66, 68 | ±0.0% |
| 90.0 | PARK MANOR BLVD + IKEA | Robinson | 28X | 25 | −8.3% |
| 86.2 | BUTLER ST + 52ND ST | Upper Lawrenceville | 87, 93 | 81, 92 | −3.7% |
| 84.1 | PARK MANOR DR + ROBINSON PLAZA | Robinson | 28X | 25 | +8.3% |
| 73.8 | BROWNSVILLE RD + WYNOKA ST | Carrick | 51L, 54 | 45 | −7.5% |
| 68.9 | BROWNSVILLE RD + MCKINLEY ST | Mount Oliver | 51L, 54 | 45 | −7.5% |
| 67.3 | PERRYSVILLE AVE + PERRY ACADEMY | Perry North | 15 | 6 | −1.8% |
| 66.0 | CHARTIERS AVE + MCKEES ROCKS PLAZA | McKees Rocks | 20 | 27 | +9.8% |
| 60.5 | BRIGHTON RD + WOODS RUN | Brighton Heights | 17 | 14 | −5.7% |
| 55.5 | E CARSON ST + 14TH ST | South Side Flats | 54 | 45, 57 | +4.3% |

The clusters worth naming:

- **Robinson** — the 28X gives way to the new 25 at IKEA and Robinson Town Centre,
  three locations and 241 boardings between them, service within 9%.
...
- **The Walmart stop in North Versailles** — 55 and 59 become 66 and 68 at
  exactly the same trip count, the single busiest substitution in the plan.

## Renumbering is not replacement

The filter that makes this answer meaningful is the crosswalk join, and it changes
the count by a factor of nearly three:

| Test | Locations | Boardings |
|---|---:|---:|
| Route sets differ, trips within 10% | 903 | 25,135 |
| …after translating current numbers to their final numbers | 751 | 22,382 |
| …and only where at most 4 routes serve the stop today | **356** | **3,449** |
...
These 356 locations are where PRT's rider communication has to do the most work.
